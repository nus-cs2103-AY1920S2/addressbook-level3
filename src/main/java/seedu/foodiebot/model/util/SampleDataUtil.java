...
public class SampleDataUtil {
    ...
    public static Food[] getSampleFoods() {
        return new Food[] { new Food("Roasted Chicken Rice", 4, "Roasted Meat and Chicken Rice", "Roasted Chicken Rice.png",
                        1, "Nus Flavors", "Duck and Chicken Rice", getTagSet("asian", "cheap", "rice")),
                        ...
                        5, "Nus Flavors", "Mala Hot Pot", getTagSet("asian", "expensive", "spicy")),
                            new Food("Fried Meatball Noodle", 5, "Fried Meatball with Minced Meat Noodles", "Fried Meatball Noodle.png",
                        6, "Nus Flavors", "Minced Meat Noodle", getTagSet("asian", "noodle")),
                        ...
                        5, "The Deck", "Muslim", getTagSet( "asian", "expensive", "spicy")),
                            new Food("Mini Hot Pot Noodle", 4, "Minced Meat Noodle with Soup", "Mini Hot Pot Noodle.png",
                        6, "The Deck", "Noodle", getTagSet("asian", "cheap", "noodles")),
