...
import seedu.eylah.diettracker.model.food.exceptions.FoodNotFoundException;
 ...
 * foodss uses Food#isSameFood(Food) for equality so as to ensure that the food being added or updated is
