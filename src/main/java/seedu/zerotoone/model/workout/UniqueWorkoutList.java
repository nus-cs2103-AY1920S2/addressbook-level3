 ...
 * updating of workouts uses Workout#isSameWorkout(Workout) for equality so as to ensure that the workout being
 * added or updated is unique in terms of identity in the UniqueWorkoutList. However, the removal of a workout uses
