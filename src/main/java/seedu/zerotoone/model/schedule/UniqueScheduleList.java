 ...
 * A schedule is considered unique by comparing using {@code Schedule#isSameSchedule(Schedule)}. As such, adding and
 * updating of schedules uses Schedule#isSameSchedule(Schedule) for equality so as to ensure that the schedule being
 * added or updated is unique in terms of identity in the UniqueScheduleList. However, the removal of a schedule uses
...
public class UniqueScheduleList implements Iterable<Schedule> {
    ...
    private final List<Schedule> internalList = new ArrayList<>();
     ...
     */
    public List<Schedule> asUnmodifiableList() {
