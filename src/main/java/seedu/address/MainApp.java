...
import seedu.address.storage.InventorySystemStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing InventorySystem ]===========================");
        super.init();
        ...
        InventorySystemStorage addressBookStorage = new JsonInventorySystemStorage(userPrefs.getAddressBookFilePath());
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty InventorySystem");
            initialData = new InventorySystem();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting InventorySystem " + MainApp.VERSION);
