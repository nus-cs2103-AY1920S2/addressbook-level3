...
public class AppUiManager implements Ui {
    public static final String ALERT_DIALOG_PANE_FIELD_ID = "alertDialogPane";

    private static final Logger logger = LogsCenter.getLogger(AppUiManager.class);
    private static final String ICON_APPLICATION = "/images/address_book_32.png";

    private AppLogic logic;
    private AppMainWindow mainWindow;

    public AppUiManager(AppLogic logic) {
        super();
        this.logic = logic;
    }
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            mainWindow = new AppMainWindow(primaryStage, logic);
