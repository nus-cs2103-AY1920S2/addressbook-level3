...
public class FocusAreaPanel extends UiPart<Region> {
    ...
    public FocusAreaPanel(CourseFocusArea courseFocusArea) throws ParseException {
        ...
        primaries.setItems(FXCollections.observableArrayList(courseFocusArea.getPrimaries()));
        electives.setItems(FXCollections.observableArrayList(courseFocusArea.getElectives()));
    }
