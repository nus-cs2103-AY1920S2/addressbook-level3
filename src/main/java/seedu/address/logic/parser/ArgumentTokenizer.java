...
public class ArgumentTokenizer {
     ...
     *
     * <p>E.g if {@code argsString} = "e/hip/900", {@code prefix} = "p/" and {@code fromIndex} = 0,
        ...
        for (int i = 0; i < prefixPositions.size() - 1; i++) {
            ...
            String argValue =
                    extractArgumentValue(
                            argsString, prefixPositions.get(i), prefixPositions.get(i + 1));
