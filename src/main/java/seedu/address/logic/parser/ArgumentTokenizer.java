...
public class ArgumentTokenizer {
     ...
     * to their respective argument values. Only the given prefixes will be recognized in the
     * arguments string.
     *
    ...
    /**
     * Returns the index of the first occurrence of {@code prefix} in {@code argsString} starting from
     * index {@code fromIndex}. An occurrence is valid if there is a whitespace before {@code prefix}.
     * Returns -1 if no such occurrence can be found.
     * <p>
     * E.g if {@code argsString} = "e/hip/900", {@code prefix} = "p/" and {@code fromIndex} = 0, this
     * method returns -1 as there are no valid occurrences of "p/" with whitespace before it. However,
     * if {@code argsString} = "e/hi p/900", {@code prefix} = "p/" and {@code fromIndex} = 0, this
     * method returns 5.
     */
     ...
     * that maps the extracted prefixes to their respective arguments. Prefixes are extracted based on
