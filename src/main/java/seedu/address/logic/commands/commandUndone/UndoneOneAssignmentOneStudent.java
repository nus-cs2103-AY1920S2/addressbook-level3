...
public class UndoneOneAssignmentOneStudent extends UndoneCommandBase {
    public static final String MESSAGE_USAGE =
            COMMAND_WORD + ": Marks an assignment as undone for a student. "
                    + "Parameters: "
    ...
    public static final String MESSAGE_INVALID_ASSIGNMENT_UNDONE = "Assignment has been marked as undone already!";
