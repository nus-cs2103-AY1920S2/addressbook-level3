...
public class EditTeacherCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the teacher identified "
     ...
     */
    private static Teacher createEditedTeacher(Teacher teacherToEdit, EditTeacherDescriptor editTeacherDescriptor) {
        ...
        return new Teacher(updatedName, updatedPhone, updatedEmail, updatedSalary, updatedAddress, updatedTags);
    }
