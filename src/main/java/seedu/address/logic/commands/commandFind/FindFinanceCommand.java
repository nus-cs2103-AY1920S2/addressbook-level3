...
public class FindFinanceCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all finances whose names contain any of "
    ...
    public CommandResult execute(Model model) {
        ...
        return new CommandResult(
                String.format(Messages.MESSAGE_FINANCES_LISTED_OVERVIEW, model.getFilteredFinanceList().size()));
    }
