...
public class HelpCommand extends Command {
    ...
    public static final String MESSAGE = "Here are the list of commands: \n"
            ...
            + "8. " + EditCommand.COMMAND_WORD + ": " + EditCommand.COMMAND_FUNCTION + "\n"
            + "9. " + DeleteCommand.COMMAND_WORD + ": " + DeleteCommand.COMMAND_FUNCTION + "\n"
            ...
            + "13. " + ListCommand.COMMAND_WORD + ": " + ListCommand.COMMAND_FUNCTION + "\n"
            + "14. " + FindCommand.COMMAND_WORD + ": " + FindCommand.COMMAND_FUNCTION + "\n"
            ...
            + "18. " + EditRestaurantCommand.COMMAND_WORD + ": " + EditRestaurantCommand.COMMAND_FUNCTION + "\n"
            + "19. " + DeleteRestaurantCommand.COMMAND_WORD + ": " + DeleteRestaurantCommand.COMMAND_FUNCTION + "\n"
            + "20. " + AddRestaurantNoteCommand.COMMAND_WORD + ": " + AddRestaurantNoteCommand.COMMAND_FUNCTION + "\n"
            + "21. " + EditRestaurantNoteCommand.COMMAND_WORD + ": " + EditRestaurantNoteCommand.COMMAND_FUNCTION + "\n"
            + "22. " + DeleteRestaurantNoteCommand.COMMAND_WORD + ": "
    ...
    public static ArrayList<String> commandList(ArrayList<String> commands) {
        ...
        commands.add("8. " + EditCommand.MESSAGE_USAGE + "\n");
        commands.add("9. " + DeleteCommand.MESSAGE_USAGE + "\n");
        ...
        commands.add("13. " + ListCommand.MESSAGE_USAGE + "\n");
        commands.add("14. " + FindCommand.MESSAGE_USAGE + "\n");
        ...
        commands.add("18. " + EditRestaurantCommand.MESSAGE_USAGE + "\n");
        commands.add("19. " + DeleteRestaurantCommand.MESSAGE_USAGE + "\n");
        commands.add("20. " + AddRestaurantNoteCommand.MESSAGE_USAGE + "\n");
        commands.add("21. " + EditRestaurantNoteCommand.MESSAGE_USAGE + "\n");
