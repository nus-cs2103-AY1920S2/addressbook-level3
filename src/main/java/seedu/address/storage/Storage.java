 ...
 */
public interface Storage extends AddressBookStorage, TeacherAddressBookStorage, StudentAddressBookStorage,
    ...
    @Override
    Optional<ReadOnlyTeacherAddressBook> readTeacherAddressBook() throws DataConversionException, IOException;
    ...
    @Override
    Optional<ReadOnlyStudentAddressBook> readStudentAddressBook() throws DataConversionException, IOException;
    ...
    @Override
    Optional<ReadOnlyFinanceAddressBook> readFinanceAddressBook() throws DataConversionException, IOException;
    ...
    @Override
    Optional<ReadOnlyCourseAddressBook> readCourseAddressBook() throws DataConversionException, IOException;
