...
public class JsonCourseAddressBookStorage implements CourseAddressBookStorage {
    ...
    @Override
    public Optional<ReadOnlyCourseAddressBook> readCourseAddressBook() throws DataConversionException {
     ...
     */
    public Optional<ReadOnlyCourseAddressBook> readCourseAddressBook(Path filePath) throws DataConversionException {
    ...
    @Override
    public void saveCourseAddressBook(ReadOnlyCourseAddressBook coursesAddressBook) throws IOException {
        saveCourseAddressBook(coursesAddressBook, filePath);
    }

    /**
     * Similar to {@link #saveCourseAddressBook(ReadOnlyCourseAddressBook)}.
     *
     * @param filePath location of the data. Cannot be null.
     */
    public void saveCourseAddressBook(ReadOnlyCourseAddressBook coursesAddressBook, Path filePath) throws IOException {
