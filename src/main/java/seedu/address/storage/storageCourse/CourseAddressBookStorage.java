...
public interface CourseAddressBookStorage {
    ...
    /**
     * Returns CourseAddressBook data as a {@link ReadOnlyCourseAddressBook}.
     ...
     */
    Optional<ReadOnlyCourseAddressBook> readCourseAddressBook(Path filePath) throws DataConversionException, IOException;
     ...
     */
    void saveCourseAddressBook(ReadOnlyCourseAddressBook courseAddressBook, Path filePath) throws IOException;
