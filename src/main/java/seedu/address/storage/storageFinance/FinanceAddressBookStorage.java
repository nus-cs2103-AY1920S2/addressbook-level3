...
public interface FinanceAddressBookStorage {
    ...
    /**
     * Returns FinanceAddressBook data as a {@link ReadOnlyFinanceAddressBook}.
     ...
     */
    Optional<ReadOnlyFinanceAddressBook> readFinanceAddressBook(Path filePath) throws DataConversionException, IOException;
     ...
     */
    void saveFinanceAddressBook(ReadOnlyFinanceAddressBook financeAddressBook, Path filePath) throws IOException;
