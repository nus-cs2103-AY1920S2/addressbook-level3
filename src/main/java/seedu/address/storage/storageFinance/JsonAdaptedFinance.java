...
class JsonAdaptedFinance {
     ...
     */
    @JsonCreator
    public JsonAdaptedFinance(@JsonProperty("name") String name, @JsonProperty("amount") String amount,
    ...
    public Finance toModelType() throws IllegalValueException {
        ...
        if (amount == null) {
            throw new IllegalValueException(String.format(MISSING_FIELD_MESSAGE_FORMAT, Finance.class.getSimpleName()));
        }
