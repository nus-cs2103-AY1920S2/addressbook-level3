...
public interface TeacherAddressBookStorage {
    ...
    /**
     * Returns TeacherAddressBook data as a {@link ReadOnlyTeacherAddressBook}.
     ...
     */
    Optional<ReadOnlyTeacherAddressBook> readTeacherAddressBook(Path filePath) throws DataConversionException, IOException;
     ...
     */
    void saveTeacherAddressBook(ReadOnlyTeacherAddressBook teacherAddressBook, Path filePath) throws IOException;
