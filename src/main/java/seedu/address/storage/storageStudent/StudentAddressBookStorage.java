...
public interface StudentAddressBookStorage {
    ...
    /**
     * Returns StudentAddressBook data as a {@link ReadOnlyStudentAddressBook}.
     ...
     */
    Optional<ReadOnlyStudentAddressBook> readStudentAddressBook(Path filePath) throws DataConversionException, IOException;
     ...
     */
    void saveStudentAddressBook(ReadOnlyStudentAddressBook studentAddressBook, Path filePath) throws IOException;
