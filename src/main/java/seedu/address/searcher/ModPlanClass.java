...
public class ModPlanClass {
    ...
    private static ArrayList<String> computerScienceReq = new ArrayList<>(Arrays.asList("CS1101S", "CS1231S", "CS2030S",
            "CS2040S", "CS2100", "CS2103T", "CS2106", "CS3230", "IS1103", "CS2101", "ES2660", "MA1521",
            "MA1101R", "ST2334"));

    private static ArrayList<String> informationSystemsReq = new ArrayList<>(Arrays.asList("CS1010J", "CS1231",
            "IS1103", "CS2030", "CS2040", "CS2102", "CS2105", "IS2101", "IS2102", "IS2103", "IS3103", "IS3106",
            "IS4100", "IS4103", "MA1301", "MA1312", "ST2334"));

    private static ArrayList<String> computerEngineeringReq = new ArrayList<>(Arrays.asList("CS1010", "CS2040C",
            "CS2113T", "CG2271", "CG2027", "EE2026", "CG2028", "EE4204", "CG2023", "CG1111", "CG1112", "CG4002",
            "CS1231", "MA1511", "MA1512", "MA1508E", "ST2334", "CS2101", "EG2401A"));

    private static ArrayList<String> businessAnalyticsReq = new ArrayList<>(Arrays.asList("BT1101", "CS1010S",
            "EC1301", "IS1103", "MKT1705X", "BT2101", "BT2102", "CS2030", "CS2040", "IS2101", "ST2334",
            "BT3102", "BT3103", "IS3103", "BT4103"));

    private static ArrayList<String> informationSecurityReq = new ArrayList<>(Arrays.asList("CS1010", "CS1231S",
