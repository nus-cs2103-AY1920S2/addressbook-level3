...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_ORDER_DISPLAYED_INDEX = "The index provided is invalid.";
    public static final String MESSAGE_INVALID_RETURN_DISPLAYED_INDEX = "The order index provided is invalid.";
