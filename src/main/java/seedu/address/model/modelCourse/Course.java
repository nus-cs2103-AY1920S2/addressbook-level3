...
public class Course {
    ...
    /**
     * Returns true if both courses of the same name have at least one other identity field that is the same.
    ...
    /**
     * Returns true if both courses have the same identity and data fields.
     * This defines a stronger notion of equality between two courses.
     */
    @Override
