 ...
 * UniqueRestaurantList. However, the removal of a restaurant uses Restaurant#equals(Object) so
...
public class UniqueRestaurantList implements Iterable<Restaurant> {
     ...
     * The restaurant identity of {@code editedRestaurant} must not be the same as another existing restaurant in t
     * he list.
     */
