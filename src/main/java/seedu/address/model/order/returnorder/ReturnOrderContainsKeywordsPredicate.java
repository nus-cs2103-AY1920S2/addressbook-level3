...
public class ReturnOrderContainsKeywordsPredicate implements Predicate<ReturnOrder> {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof ReturnOrderContainsKeywordsPredicate // instanceof handles nulls
                && keywords.equals(((ReturnOrderContainsKeywordsPredicate) other).keywords)); // state check
    }
