...
public class StudentAddressBook implements ReadOnlyStudentAddressBook {
  ...
  /**
   * Replaces the contents of the student list with {@code students}. {@code student} must not
   * contain duplicate students.
   */
  ...
  /**
   * Replaces the given student {@code target} in the list with {@code editedStudent}. {@code
   * target} must exist in the address book. The student identity of {@code editedStudent} must not
