...
public class UniqueStudentList implements Iterable<Student> {
  ...
  /**
   * Replaces the student {@code target} in the list with {@code editedStudent}. {@code target} must
   * exist in the list. The Student identity of {@code editedStudent} must not be the same as
