    ...
    public static Order[] getSampleOrders() {
        return new Order[] {
            new Order(new TransactionId("B93838282"), new Name("Alex Yeoh"), new Phone("87438807"),
                    new Email("asdbc@gmail.com"), new Address("Blk 30 Geylang Street 29, #06-40"), new TimeStamp("2019-02-20 1500"),
            ...
            new Order(new TransactionId("A11111111"), new Name("Bernice Yu"), new Phone("99272758"),
                    new Email("asdbc@gmail.com"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new TimeStamp("2019-02-20 1500"),
            ...
            new Order(new TransactionId("A4937272"), new Name("Charlotte Oliveiro"), new Phone("93210283"),
                    new Email("asdbc@gmail.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new TimeStamp("2019-02-20 1500"),
            ...
            new Order(new TransactionId("A000000"), new Name("David Li"), new Phone("91031282"),
                    new Email("asdbc@gmail.com"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new TimeStamp("2019-02-20 1500"),
            ...
            new Order(new TransactionId("A99999"), new Name("Irfan Ibrahim"), new Phone("92492021"),
                    new Email("asdbc@gmail.com"), new Address("Blk 47 Tampines Street 20, #17-35"), new TimeStamp("2019-02-20 1500"),
            ...
            new Order(new TransactionId("C8493929292"), new Name("Roy Balakrishnan"), new Phone("92624417"),
                    new Email("asdbc@gmail.com"), new Address("Blk 45 Aljunied Street 85, #11-31"), new TimeStamp("2019-02-20 1500"),
