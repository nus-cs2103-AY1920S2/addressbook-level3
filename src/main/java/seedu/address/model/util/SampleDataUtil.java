    ...
    public static Order[] getSampleOrders() {
        return new Order[] {
            new Order(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Address("Blk 30 Geylang Street 29, #06-40 S388192"), new TimeStamp("2019-02-20 1500"),
            ...
            new Order(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18 S556053"), new TimeStamp("2019-02-20 1500"),
                new Warehouse("5 Toh Guan Rd E, S608831"), new Comment("NIL"),
                getTagSet("colleagues", "friends")),
            new Order(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04 S560101"), new TimeStamp("2019-02-20 1500"),
                new Warehouse("5 Toh Guan Rd E, S608831"), new Comment("NIL"),
                getTagSet("neighbours")),
            new Order(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43 S556054"), new TimeStamp("2019-02-20 1500"),
                new Warehouse("5 Toh Guan Rd E, S608831"), new Comment("NIL"),
                getTagSet("family")),
            new Order(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 32, #17-35 S529287"), new TimeStamp("2019-02-20 1500"),
                new Warehouse("5 Toh Guan Rd E, S608831"), new Comment("NIL"),
                getTagSet("classmates")),
            new Order(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Avenue 1, #11-31 S389977"), new TimeStamp("2019-02-20 1500"),
                new Warehouse("5 Toh Guan Rd E, S608831"), new Comment("NIL"),
