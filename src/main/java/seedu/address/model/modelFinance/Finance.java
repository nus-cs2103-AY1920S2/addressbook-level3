...
/**
 * Represents a Finance in the address book.
...
public class Finance {
    ...
    /**
     * Returns true if both finances of the same name have at least one other identity field that is the same.
    ...
    /**
     * Returns true if both finances have the same identity and data fields.
     * This defines a stronger notion of equality between two finances.
     */
    @Override
