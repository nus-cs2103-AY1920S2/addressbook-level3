...
/**
 * A list of assignments that enforces uniqueness between its elements and does not allow nulls. A
 * assignment is considered unique by comparing using {@code Assignment#isSameAssignment(Assignment)}. As such,
 ...
 * However, the removal of a course uses assignment#equals(Object) so as to ensure that the course with
...
public class UniqueAssignmentList implements Iterable<Assignment> {
  ...
  /**
   * Adds an assignment to the list. The assignment must not already exist in the list.
   */
  ...
  /**
   * Replaces the course {@code target} in the list with {@code editedAssignment}. {@code target} must
   * exist in the list. The Assignment identity of {@code editedAssignment} must not be the same as another
  ...
  /**
   * Removes the equivalent Assignment from the list. The Assignment must exist in the list.
   */
  ...
  /**
   * Replaces the contents of this list with {@code assignments}. {@code assignments} must not contain
  ...
  public boolean equals(Object other) {
    return other == this // short circuit if same object
        || (other instanceof UniqueAssignmentList
