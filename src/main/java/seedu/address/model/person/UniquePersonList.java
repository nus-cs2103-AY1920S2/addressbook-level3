 ...
 * updating of persons uses Student#isSamePerson(Student) for equality so as to ensure that the student being added or
 * updated is unique in terms of identity in the UniquePersonList. However, the removal of a student uses
