...
public class Teacher {
     ...
     */
    public Teacher(Name name, Phone phone, Email email, Salary salary, Address address, Set<Tag> tags) {
    ...
    /**
     * Returns true if both teachers of the same name have at least one other identity field that is the same.
    ...
    public boolean isSameTeacher(Teacher otherTeacher) {
        ...
        return otherTeacher != null
                ...
                && (otherTeacher.getPhone().equals(getPhone()) || (otherTeacher.getSalary().equals(getSalary())|| otherTeacher.getEmail().equals(getEmail())));
    }
