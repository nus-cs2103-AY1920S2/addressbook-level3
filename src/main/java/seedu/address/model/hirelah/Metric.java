...
public class Metric {
    ...
    /**
     * Constructs a Comparator for Intervieee based on the weighted score.
    ...
    /**
     * Computes the final score of an interviewee.
     * @param interviewee The interviewee that wants to be computed.
