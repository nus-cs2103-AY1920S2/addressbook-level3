...
public class MainApp extends Application {
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s nasa book and {@code userPrefs}. <br>
     * The data from the sample nasa book will be used instead if {@code storage}'s nasa book is not found,
     * or an empty nasa book will be used instead if errors occur when reading {@code storage}'s nasa book.
     */
