...
public class DeleteCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_PERSON_SUCCESS = "Deleted Coupon: %1$s";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        model.deletePerson(couponToDelete);
        return new CommandResult(String.format(MESSAGE_DELETE_PERSON_SUCCESS, couponToDelete));
    }
