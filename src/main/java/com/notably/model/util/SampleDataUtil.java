...
public class SampleDataUtil {
    ...
    private static Block step2 = new BlockImpl(new Title("Step 2"),
        new Body("You're a navigation master at this point! Well done!\nLet's add a new note here! Type 'new -t A "
            + "new title -b Contents here' to create a child note here with the title 'A new title' and the body "
    ...
    public static BlockTree getSampleBlockTree() {
        ...
        sampleBt.add(AbsolutePath.fromString("/Welcome/Step 1"), step2);
