...
public class SampleDataUtil {
    ...
    public static Entry[] getSampleEntries() {
        return new Entry[]{
            ...
            new Entry(new Type("sports"), new Name("Running"), new Time("2020-04-02 13:00"),
            ...
            new Entry(new Type("f"), new Name("Ice-cream"), new Time("2020-03-31 17:30"),
            ...
            new Entry(new Type("food"), new Name("Chicken Rice"), new Time("2020-03-01 16:30"),
                new Location("Utown FineFood"), new Calorie("200")),
            new Entry(new Type("food"), new Name("Chicken Rice"), new Time("2020-03-01 18:30"),
            ...
            new Entry(new Type("sports"), new Name("Football"), new Time("2019-12-01 11:00"),
                new Location("NUS Trackfield"), new Calorie("400"), new Duration("1")),
            new Entry(new Type("s"), new Name("Walking"), new Time("2020-02-01 20:20"),
