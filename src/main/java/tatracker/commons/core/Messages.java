...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_STUDENT_DISPLAYED_INDEX = "There is no student with the given matric"
            + " number: A9999999J inside the module group G06 [CS3243].";
    ...
    public static final String MESSAGE_INVALID_STUDENTS = "There are no groups in this module!";
}
