...
public class AddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + SAVINGS_DESC_BOB + EXPIRY_DATE_DESC_BOB
                + USAGE_DESC_BOB + LIMIT_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid expiry date
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SAVINGS_DESC_BOB + INVALID_EXPIRY_DATE_DESC
