...
public class JsonAdaptedCouponTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedCoupon coupon =
                new JsonAdaptedCoupon(INVALID_NAME, VALID_PHONE, VALID_USAGE, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedCoupon coupon = new JsonAdaptedCoupon(null, VALID_PHONE, VALID_USAGE, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedCoupon coupon =
                new JsonAdaptedCoupon(VALID_NAME, INVALID_PHONE, VALID_USAGE, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedCoupon coupon = new JsonAdaptedCoupon(VALID_NAME, null, VALID_USAGE, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedCoupon coupon =
                new JsonAdaptedCoupon(VALID_NAME, VALID_PHONE, VALID_USAGE, invalidTags);
