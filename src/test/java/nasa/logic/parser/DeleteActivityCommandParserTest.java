...
public class DeleteActivityCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteActivityCommand() {
        assertParseSuccess(parser, "1" + MODULE_DESC_CS1231, new DeleteActivityCommand(Index.fromOneBased(1),
                moduleCode));
    }
    ...
    public void parse_invalidArgs_throwsParseException() {
        ...
        assertParseFailure(parser, MODULE_DESC_CS1231, String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                DeleteActivityCommand.MESSAGE_USAGE));
