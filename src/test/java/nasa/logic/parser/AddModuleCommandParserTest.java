...
public class AddModuleCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + MODULE_DESC_CS1231 + MODULE_NAME_DESC_CS1231, new AddModuleCommand(CS1231));

        // multiple module codes - only the last one is taken into account
        assertParseSuccess(parser, MODULE_DESC_CS2030 + MODULE_DESC_CS1231 + MODULE_NAME_DESC_CS1231, new AddModuleCommand(CS1231));

        // multiple module names - only the last one is taken into account
        assertParseSuccess(parser, MODULE_DESC_CS1231 + MODULE_NAME_DESC_CS2030 + MODULE_NAME_DESC_CS1231, new AddModuleCommand(CS1231));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid module code
        assertParseFailure(parser, INVALID_MODULE_DESC + MODULE_NAME_DESC_CS1231, ModuleCode.MESSAGE_CONSTRAINTS);

        // invalid module name
        assertParseFailure(parser, MODULE_DESC_CS1231 + INVALID_MODULE_NAME_DESC, ModuleName.MESSAGE_CONSTRAINTS);
    }
}
