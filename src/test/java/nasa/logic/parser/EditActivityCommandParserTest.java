...
public class EditActivityCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1" + MODULE_DESC_CS2030, EditActivityCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_invalidPreamble_failure() {
        ...
        assertParseFailure(parser, "1 " + MODULE_DESC_CS2030 + " i/ string", MESSAGE_INVALID_FORMAT);
    ...
    public void parse_invalidValue_failure() {
        assertParseFailure(parser, "1" + MODULE_DESC_CS2030 + INVALID_ACTIVITY_NAME_DESC,
                Name.MESSAGE_CONSTRAINTS); // invalid phone
        assertParseFailure(parser, "1" + MODULE_DESC_CS2030 + INVALID_DATE_DESC,
                Date.MESSAGE_CONSTRAINTS); // invalid email
        assertParseFailure(parser, "1" + MODULE_DESC_CS2030 + INVALID_NOTES_DESC,
                Note.MESSAGE_CONSTRAINTS); // invalid address
        assertParseFailure(parser, "1" + MODULE_DESC_CS2030 + INVALID_PRIORITY_DESC,
        ...
        assertParseFailure(parser, "1" + MODULE_DESC_CS2030 + VALID_PRIORITY_HIGH + INVALID_PRIORITY_DESC,
                Priority.MESSAGE_CONSTRAINTS);

        // multiple invalid values, but only the first invalid value is captured
        assertParseFailure(parser, "1" + MODULE_DESC_CS2030 + INVALID_PRIORITY_DESC + INVALID_NOTES_DESC
