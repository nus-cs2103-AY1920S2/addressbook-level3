...
public class AddEventCommandParserTest {
    ...
    public void parse_compulsoryFieldsMissing_failure() {
        ...
        assertParseFailure(parser, MODULE_DESC_CS1231 + DATE_DESC_TEST_TO + DATE_DESC_TEST_FROM
            + PRIORITY_DESC_HIGH + NOTES_DESC_TEST, expectedMessage);

        // missing from-date
        assertParseFailure(parser, MODULE_DESC_CS1231 + ACTIVITY_NAME_DESC_EXAM + DATE_DESC_TEST_TO
            + PRIORITY_DESC_HIGH + NOTES_DESC_TEST, expectedMessage);

        // missing to-date
        assertParseFailure(parser, MODULE_DESC_CS1231 + ACTIVITY_NAME_DESC_EXAM + DATE_DESC_TEST_FROM
            + PRIORITY_DESC_HIGH + NOTES_DESC_TEST, expectedMessage);
    }
