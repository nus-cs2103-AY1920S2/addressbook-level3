...
public class EditSuggestionCommandTest {
    ...
    public void constructor_nullPath_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> new EditSuggestionCommand(null));
    }

    @Test
    public void execute_nullModel_throwsNullPointerException() {
        EditSuggestionCommand editSuggestionCommand = new EditSuggestionCommand(toRoot);
        assertThrows(NullPointerException.class, () -> editSuggestionCommand.execute(null));
    }

    @Test
    public void execute_displayText() {
        EditSuggestionCommand editSuggestionCommand = new EditSuggestionCommand(toCs2103);
        editSuggestionCommand.execute(model);

        assertEquals(Optional.of("Edit a note"), model.responseTextProperty().getValue());
    ...
    public void execute_action() {
        EditSuggestionCommand editSuggestionCommand = new EditSuggestionCommand(toCs2103Week1);
        editSuggestionCommand.execute(model);
