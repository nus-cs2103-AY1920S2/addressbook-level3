...
class TransactionsPanelTest {
    private TransactionsPanel panel = new TransactionsPanel(getTypicalFoodieBot().getPurchasedFoodList());
    private ListView<PurchasedFood> listView;
    ...
    void init(FxRobot robot) {
        FxAssert.verifyThat(listView, ListViewMatchers.hasItems(0));
    }
}
