...
public class OfferTest {
    ...
    public void constructor_anyNull_throwsNullPointerException() {
        ...
        assertThrows(NullPointerException.class, () -> new Offer(new Good(VALID_GOOD_BLUEBERRY), null));
        assertThrows(NullPointerException.class, () -> new Offer(null, new Price(VALID_PRICE_CHEAP)));
    }

    @Test
    public void equals_self_returnsTrue() {
        Offer offer = new Offer(new Good(VALID_GOOD_APPLE), new Price(VALID_PRICE_EXPENSIVE));
    ...
    public void equals_sameGoodSamePrice_returnsTrue() {
        Offer offer = new Offer(new Good(VALID_GOOD_APPLE), new Price(VALID_PRICE_EXPENSIVE));
        Offer same = new Offer(new Good(VALID_GOOD_APPLE), new Price(VALID_PRICE_EXPENSIVE));
    ...
    public void equals_sameGoodDifferentPrice_returnsTrue() {
        Offer offer = new Offer(new Good(VALID_GOOD_APPLE), new Price(VALID_PRICE_EXPENSIVE));
        Offer differentPrice = new Offer(new Good(VALID_GOOD_APPLE), new Price(VALID_PRICE_CHEAP));
    ...
    public void equals_differentGoodSamePrice_returnsFalse() {
        Offer offer = new Offer(new Good(VALID_GOOD_APPLE), new Price(VALID_PRICE_EXPENSIVE));
        Offer differentGood = new Offer(new Good(VALID_GOOD_BLUEBERRY), new Price(VALID_PRICE_EXPENSIVE));
    ...
    public void equals_differentGoodDifferentPrice_returnsFalse() {
        Offer offer = new Offer(new Good(VALID_GOOD_APPLE), new Price(VALID_PRICE_EXPENSIVE));
        Offer offer2 = new Offer(new Good(VALID_GOOD_BLUEBERRY), new Price(VALID_PRICE_CHEAP));
