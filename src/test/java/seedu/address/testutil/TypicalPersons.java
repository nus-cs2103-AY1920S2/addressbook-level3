...
public class TypicalPersons {
    ...
    public static final Order AMY = new OrderBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withComment("NIL")
            .withTags(VALID_TAG_FRIEND).build();
    public static final Order BOB = new OrderBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withComment("NIL")
    ...
    public static OrderBook getTypicalAddressBook() {
        ...
        for (Order order : getTypicalPersons()) {
            ab.addOrder(order);
        }
        return ab;
    }

    public static List<Order> getTypicalPersons() {
