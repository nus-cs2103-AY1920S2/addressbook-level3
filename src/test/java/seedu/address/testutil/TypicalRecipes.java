...
import static seedu.address.logic.commands.CommandTestUtil.VALID_VEGETABLE_FISH;
import static seedu.address.logic.commands.CommandTestUtil.VALID_VEGETABLE_TURKEY_SANDWICH;
...
public class TypicalRecipes {
    ...
    public static final Recipe CAESAR_SALAD = new RecipeBuilder().withName("Caesar Salad")
            .withTime("10")
            .withVegetables("Tomato, 100")
            .withOthers("Honeydew, 100")
    ...
    public static final Recipe TURKEY_SANDWICH = new RecipeBuilder().withName(VALID_NAME_TURKEY_SANDWICH)
            ...
            .withVegetables(VALID_VEGETABLE_TURKEY_SANDWICH)
    ...
    public static final Recipe FISH = new RecipeBuilder().withName(VALID_NAME_FISH).withTime(VALID_TIME_FISH)
            ...
            .withVegetables(VALID_VEGETABLE_FISH)
