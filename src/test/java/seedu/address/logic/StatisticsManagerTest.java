...
public class StatisticsManagerTest {
    ...
    public void updateStatisticsDisplayValues_typicalDayDatas_success() {
        ...
        String expectedProgressBarDailyFilepathString = "/images/progress/ProgressBar" + String.valueOf(expectedPercentage) + "%.png";
        ...
        assertEquals(statisticsManager.getProgressBarDailyFilepathString(), expectedProgressBarDailyFilepathString);
    }

    @Test
    public void updateStatisticsDisplayValues_nullStatistics_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> statisticsManager.updateStatisticsDisplayValues(getTypicalDayDatas()));
    }

    @Test
    public void updateStatisticsDisplayValues_nullDayDatas_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> statisticsManager.updateStatisticsDisplayValues(null));
    }
