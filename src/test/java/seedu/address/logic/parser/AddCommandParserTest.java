...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + TID_DESC_BOB +NAME_DESC_BOB + PHONE_DESC_BOB
                + ADDRESS_DESC_BOB + WAREHOUSE_DESC_BOB + COD_DESC_BOB + COMMENT_DESC_NIL + TAG_DESC_FRIEND,
        ...
        assertParseSuccess(parser, TID_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + ADDRESS_DESC_BOB
                + WAREHOUSE_DESC_AMY + WAREHOUSE_DESC_BOB + COD_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedOrder));

        // multiple cashOnDeliveries - last cashOnDelivery accepted
        assertParseSuccess(parser, TID_DESC_BOB + NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB
                        + ADDRESS_DESC_BOB + WAREHOUSE_DESC_BOB + COD_DESC_AMY + COD_DESC_BOB +
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, TID_DESC_AMY + NAME_DESC_AMY + PHONE_DESC_AMY + ADDRESS_DESC_AMY
                + WAREHOUSE_DESC_AMY + COD_DESC_AMY , new AddCommand(expectedOrder));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, TID_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + ADDRESS_DESC_BOB + COD_DESC_BOB,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid warehouse
        assertParseFailure(parser, TID_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_WAREHOUSE_DESC + COD_DESC_BOB + TAG_DESC_FRIEND, Warehouse.MESSAGE_CONSTRAINTS);

        // invalid cashOnDelivery
        assertParseFailure(parser, TID_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + ADDRESS_DESC_BOB
                + WAREHOUSE_DESC_BOB + INVALID_COD_DESC + TAG_DESC_FRIEND, Warehouse.MESSAGE_CONSTRAINTS);

        // invalid comment
        assertParseFailure(parser, TID_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_COMMENT_DESC + WAREHOUSE_DESC_BOB + COD_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Comment.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, TID_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + ADDRESS_DESC_BOB
                + WAREHOUSE_DESC_BOB + COD_DESC_BOB + COMMENT_DESC_NIL + INVALID_TAG_DESC
        ...
        assertParseFailure(parser, TID_DESC_BOB + INVALID_NAME_DESC + PHONE_DESC_BOB + INVALID_ADDRESS_DESC
                + WAREHOUSE_DESC_BOB + COD_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + TID_DESC_BOB +  NAME_DESC_BOB + PHONE_DESC_BOB
                + ADDRESS_DESC_BOB + WAREHOUSE_DESC_BOB + COD_DESC_BOB + COMMENT_DESC_NIL + TAG_DESC_HUSBAND
