...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + WAREHOUSE_DESC_BOB + COMMENT_DESC_NIL + TAG_DESC_FRIEND,
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + WAREHOUSE_DESC_BOB + COMMENT_DESC_INSTRUCTION + COMMENT_DESC_NIL + TAG_DESC_FRIEND,
                new AddCommand(expectedOrder));
        ...
        Order expectedOrderMultipleTags = new OrderBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + WAREHOUSE_DESC_BOB + COMMENT_DESC_NIL + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid comment
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_COMMENT_DESC + WAREHOUSE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Comment.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + WAREHOUSE_DESC_BOB + COMMENT_DESC_NIL + INVALID_TAG_DESC + VALID_TAG_FRIEND, Tag.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + WAREHOUSE_DESC_BOB + COMMENT_DESC_NIL + TAG_DESC_HUSBAND
