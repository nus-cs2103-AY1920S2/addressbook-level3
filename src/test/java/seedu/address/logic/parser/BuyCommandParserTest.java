...
class BuyCommandParserTest {
    ...
    private static final String VALID_SUPPLIER_NAME = "Fairprice";
    ...
    private static final String VALID_SUPPLIER_NAME_DESC = " " + PREFIX_NAME + VALID_SUPPLIER_NAME;
    ...
    void parse_invalidValue_failure() {
        // invalid good name
        assertParseFailure(parser, INVALID_GOOD_NAME_DESC + VALID_GOOD_QUANTITY_DESC + VALID_SUPPLIER_NAME_DESC,
        ...
        assertParseFailure(parser, VALID_GOOD_NAME_DESC + INVALID_GOOD_QUANTITY_NEGATIVE_DESC
                + VALID_SUPPLIER_NAME_DESC, GoodQuantity.MESSAGE_CONSTRAINTS);
