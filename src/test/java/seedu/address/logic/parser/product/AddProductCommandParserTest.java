...
public class AddProductCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, DESCRIPTION_DESC_BAG + DESCRIPTION_DESC_WATCH + PRICE_DESC_WATCH + QUANTITY_DESC_WATCH
                + SALES_DESC_WATCH, new AddProductCommand(expectedProduct));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing sales prefix
        assertParseFailure(parser, DESCRIPTION_DESC_WATCH + PRICE_DESC_WATCH + QUANTITY_DESC_WATCH + VALID_SALES_WATCH,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_DESCRIPTION_WATCH + VALID_PRICE_WATCH + VALID_QUANTITY_WATCH + VALID_SALES_WATCH,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid address
        assertParseFailure(parser, DESCRIPTION_DESC_WATCH + PRICE_DESC_WATCH + QUANTITY_DESC_WATCH + INVALID_SALES_DESC,
                Sales.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_DESCRIPTION_DESC + PRICE_DESC_WATCH + QUANTITY_DESC_WATCH + INVALID_SALES_DESC,
                Description.MESSAGE_CONSTRAINTS);
