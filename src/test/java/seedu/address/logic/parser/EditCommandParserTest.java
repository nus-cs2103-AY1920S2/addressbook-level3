...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_TIME_DESC + EMAIL_DESC_TURKEY_SANDWICH, Time.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_TIME_TURKEY_SANDWICH,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + TIME_DESC_FISH + GOAL_DESC_PROTEIN
                + EMAIL_DESC_TURKEY_SANDWICH + NAME_DESC_TURKEY_SANDWICH + GOAL_DESC_GRAIN;

        EditRecipeDescriptor descriptor = new EditRecipeDescriptorBuilder().withName(VALID_NAME_TURKEY_SANDWICH)
                .withTime(VALID_TIME_FISH).withEmail(VALID_EMAIL_TURKEY_SANDWICH)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + TIME_DESC_FISH + EMAIL_DESC_TURKEY_SANDWICH;

        EditRecipeDescriptor descriptor = new EditRecipeDescriptorBuilder().withTime(VALID_TIME_FISH)
                .withEmail(VALID_EMAIL_TURKEY_SANDWICH).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // email
        userInput = targetIndex.getOneBased() + EMAIL_DESC_TURKEY_SANDWICH;
        descriptor = new EditRecipeDescriptorBuilder().withEmail(VALID_EMAIL_TURKEY_SANDWICH).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_RECIPE;
        String userInput = targetIndex.getOneBased() + TIME_DESC_TURKEY_SANDWICH + EMAIL_DESC_TURKEY_SANDWICH
                + GOAL_DESC_GRAIN + TIME_DESC_TURKEY_SANDWICH + EMAIL_DESC_TURKEY_SANDWICH + GOAL_DESC_GRAIN
                + TIME_DESC_FISH + EMAIL_DESC_FISH + GOAL_DESC_PROTEIN;

        EditRecipeDescriptor descriptor = new EditRecipeDescriptorBuilder().withTime(VALID_TIME_FISH)
                .withEmail(VALID_EMAIL_FISH).withGoals(VALID_GOAL_GRAIN, VALID_GOAL_PROTEIN)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_FISH + INVALID_TIME_DESC + TIME_DESC_FISH;

        descriptor = new EditRecipeDescriptorBuilder().withTime(VALID_TIME_FISH).withEmail(VALID_EMAIL_FISH).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
