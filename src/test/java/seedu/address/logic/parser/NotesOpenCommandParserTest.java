...
public class NotesOpenCommandParserTest {
    ...
    public void parse_emptyArg_throwsParseException() {
        assertParseFailure(parser, "     ",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, NotesOpenCommand.MESSAGE_USAGE));
    }

    @Test
    public void parse_validArgs_returnsNotesOpenCommand() {
        NotesOpenCommand expectedNotesOpenCommand = new NotesOpenCommand(testNote);
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, NotesOpenCommand.MESSAGE_USAGE);
