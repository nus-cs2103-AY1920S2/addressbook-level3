...
import static seedu.address.testutil.customer.TypicalPersons.AMY;
...
import seedu.address.storage.JsonInventorySystemStorage;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonInventorySystemStorage addressBookStorage =
                new JsonInventorySystemStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_validCommand_success() throws Exception {
        ...
        assertCommandSuccess(listCommand, ListCustomerCommand.MESSAGE_EMPTY, model);
    }
     ...
     */
    private static class JsonAddressBookIoExceptionThrowingStub extends JsonInventorySystemStorage {
