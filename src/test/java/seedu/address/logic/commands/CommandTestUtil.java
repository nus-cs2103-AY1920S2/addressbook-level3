...
public class CommandTestUtil {
        ...
        public static final String INVALID_PHONE_DESC = " " + PREFIX_PRIORITY + "911a"; // 'a' not allowed in prioritys
        public static final String INVALID_ADDRESS_DESC = " " + PREFIX_DESCRIPTION; // empty string not allowed for
                                                                                    // addresses
