...
import static seedu.delino.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_ADDRESS_BOB;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_COD_AMY;
...
import static seedu.delino.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_EMAIL_BOB;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_NAME_AMY;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_NAME_BOB;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_PHONE_AMY;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_PHONE_BOB;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_RETURN_TID_AMY;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_RETURN_TID_BOB;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_TID_AMY;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_TID_BOB;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_TIMESTAMP_AMY;
...
import static seedu.delino.logic.commands.CommandTestUtil.VALID_WAREHOUSE_AMY;
import static seedu.delino.logic.commands.CommandTestUtil.VALID_WAREHOUSE_BOB;
import static seedu.delino.logic.commands.ImportCommand.OT_ORDER;
import static seedu.delino.logic.commands.ImportCommand.OT_RETURN;
...
public class CsvUtil {
    ...
    public static final String ADDTIONAL_NAME_CSV_ORDER_AMY = new CsvBuilder()
        .withOutOrderTypePrefix(OT_ORDER).withTid(0, 0, 0, VALID_TID_AMY + "1").withName(0, 0, 0, VALID_NAME_AMY)
        .withAddress(0, 0, 0, VALID_ADDRESS_AMY).withPhone(0, 0, 0, VALID_PHONE_AMY)
        .withDeliveryTimeStamp(0, 0, 0, VALID_TIMESTAMP_AMY).withWarehouse(0, 0, 0, VALID_WAREHOUSE_AMY)
    ...
    public static final String VALID_CSV_RETURN_ORDER_AMY = new CsvBuilder()
        .withOutOrderTypePrefix(OT_RETURN).withTid(0, 0, 0, VALID_RETURN_TID_AMY)
    ...
    public static final String VALID_CSV_RETURN_ORDER_BOB = new CsvBuilder()
        .withOutOrderTypePrefix(OT_RETURN).withTid(0, 0, 0, VALID_RETURN_TID_BOB).withName(0, 0, 0, VALID_NAME_BOB)
        .withAddress(0, 0, 0, VALID_ADDRESS_BOB).withPhone(0, 0, 0, VALID_PHONE_BOB)
    ...
    public static final String INVALID_CSV_RETURN_ORDER_AMY = new CsvBuilder()
        .withOutOrderTypePrefix("sds" + OT_RETURN)
        .withTid(0, 0, 0, VALID_RETURN_TID_AMY)
    ...
    public static final String INVALID_CSV_RETURN_ORDER_BOB = new CsvBuilder()
        .withOutOrderTypePrefix(OT_RETURN + " ds")
        .withTid(0, 0, 0, VALID_RETURN_TID_BOB)
        .withName(0, 0, 0, VALID_NAME_BOB)
        .withAddress(0, 0, 0, VALID_ADDRESS_BOB)
        .withPhone(0, 0, 0, VALID_PHONE_BOB)
        .withReturnTimeStamp(0, 0, 0, VALID_TIMESTAMP_BOB)
        .withWarehouse(0, 0, 0, VALID_WAREHOUSE_BOB)
        .withComment(0, 0, 0, VALID_COMMENT_NIL)
        .withEmail(0, 0, 0, VALID_EMAIL_BOB)
        .withTypeOfItem(0, 0, 0, VALID_TYPE_PLASTIC)
        .build();

    public static final String ADDTIONAL_NAME_CSV_RETURN_ORDER_AMY = new CsvBuilder()
        .withOutOrderTypePrefix(OT_RETURN).withTid(0, 0, 0, VALID_RETURN_TID_AMY).withName(0, 0, 0, VALID_NAME_AMY)
        .withAddress(0, 0, 0, VALID_ADDRESS_AMY).withPhone(0, 0, 0, VALID_PHONE_AMY)
        .withReturnTimeStamp(0, 0, 0, VALID_TIMESTAMP_AMY).withWarehouse(0, 0, 0, VALID_WAREHOUSE_AMY)
    ...
    public static final String VALID_WHITESPACE_IN_BETWEEN_RETURN_ORDER_BOB = new CsvBuilder()
        .withOutOrderTypePrefix(OT_RETURN).withTid(0, 3, 3, VALID_RETURN_TID_BOB).withName(0, 3, 0, VALID_NAME_BOB)
