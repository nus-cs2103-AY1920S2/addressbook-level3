...
public class FoodBookParserTest {
    ...
    public void parseCommand_bmi() throws Exception {
        BmiCommand command = (BmiCommand) parser.parseCommand(
                BmiCommand.COMMAND_WORD + " " + CliSyntax.PREFIX_HEIGHT + " 170.2 " + CliSyntax.PREFIX_WEIGHT + " 67"
                        + ".5");
    ...
    public void parseCommand_list() throws Exception {
        ...
        assertTrue(parser.parseCommand(ListCommand.COMMAND_WORD + " -d") instanceof ListCommand);
        assertTrue(parser.parseCommand(ListCommand.COMMAND_WORD + " -t 3") instanceof ListCommand);
    }
