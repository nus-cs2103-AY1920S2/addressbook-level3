...
* Delino is a simple desktop application that serves to help type-fast delivery couriers to manage their parcels and deliveries on a daily basis.
* Delino has a GUI but most of the user interactions happen using a CLI (Command Line Interface).
