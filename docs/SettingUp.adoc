...
. Run the `seedu.eylah.Eylah` and try a few commands
...
When you are ready to start coding, we recommend that you get some sense of the overall design by reading about <<DeveloperGuide#Design-Architecture, EYLAH's architecture>>.
