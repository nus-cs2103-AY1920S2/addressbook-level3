...
[NOTE]
====
This document was originally written for _ExerciseList Level 4_ and hence its screenshots refer to `exerciseList-level4`.
For use with _ExerciseList Level 3_, wherever `exerciseList-level4` is used in the screenshots, you should use *`exerciseList-level3`*.
====
...
+
----
https://ci.appveyor.com/project/damithc/exerciseList-level3[image:https://ci.appveyor.com/api/projects/status/3boko2x2vr5cc3w2?svg=true[Build status]]
----
+
