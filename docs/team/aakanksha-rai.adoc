...
to which group and module they are a part of. These models are required to ensure the
...
I created a lot of supporting methods to support the UI, especially the highlighting feature.
