...
* *Major enhancement*: added the https://ay1920s2-cs2103t-f11-2.github.io/main/UserGuide.html#miscellaneous-features[Command Autocomplete] feature, which allows users to conveniently autocomplete commands and their parameter prefixes using the kbd:[Tab] key.
...
* *Minor enhancement*: developed the https://ay1920s2-cs2103t-f11-2.github.io/main/UserGuide.html#export-as-csv-code-export-code[`export`] command which allows users to export their clients' recorded exercises into a CSV file which can then be viewed in other spreadsheet software like Microsoft Excel, or easily shared with their clients.

* *Minor enhancement*: redesigned the overall user interface and added better visual feedback cues to the GUI which will glow green if the command is successful, and red if not.
