...
* *Major enhancement*: added the <<command-autocomplete>> feature, which allows users to conveniently autocomplete commands and their parameter prefixes using the kbd:[Tab] key.
...
* *Major enhancement*: added the <<command-history>> feature, which allows users to store their previously entered commands, and which they can access any time using the kbd:[&uarr;] and kbd:[&darr;] keys.
