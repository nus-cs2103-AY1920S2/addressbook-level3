...
. *Updated `edit` feature* (Pull request https://github.com/AY1920S2-CS2103T-W12-1/main/pulls?page=1&q=is%3Apr+is%3Aclosed+author%3Akhsc96[#234]) +
...
. Refine constraint of receiver name (Pull requests: https://github.com/AY1920S2-CS2103T-W12-1/main/pull/305[#305])
