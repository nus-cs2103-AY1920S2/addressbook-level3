...
* *Major enhancement*:
** *Added `search` command* (Pull request https://github.com/AY1920S2-CS2103T-W12-1/main/pull/187[#187]) +
Functionality of command can be found <<../UserGuide.adoc#search, here>> and implementation of it can be found <<../DeveloperGuide.adoc#search, here>>.
*** *What it does*: +
...
*** *Highlights*: +
This command provide various options for the user
