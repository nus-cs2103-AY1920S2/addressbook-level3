...
*** *What it does:* +
Receipt is used to store multiple Entries, and these Entries are meant to store the information about a particular Item
...
*** *What it does:* +
CalculateUtil does all the handling of calculations required in EYLAH. ParserUtil parses all the inputted texts and
outputs them as the required Objects.
