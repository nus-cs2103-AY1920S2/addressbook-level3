...
** Highlights: Many of the future features will require the exercise classes. Therefore, it was essential to have thorough considerations on how the classes are implemented. I also wrote a substantial amount of code to test the classes while practicing good test case designs like boundary value analysis. This will help reduce further bugs when expanding the application.
