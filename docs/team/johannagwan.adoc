...
** Justification: `SuggestionEngine` plays a pivotal role in providing a seamless user experience of managing the user's notes.
...
by giving a list of suggestions of the notes that the users want to open/ delete, just by typing the first few characters of their input.
** Highlights: It displays response text and suggestions (if any) for all available valid commands in Notably. The implementation was
