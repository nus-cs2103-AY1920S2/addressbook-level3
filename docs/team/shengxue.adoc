...
include::../DeveloperGuide.adoc[tag=xue1]
include::../DeveloperGuide.adoc[tag=xue2]
include::../DeveloperGuide.adoc[tag=xue3]
include::../DeveloperGuide.adoc[tag=xue4]
include::../DeveloperGuide.adoc[tag=xue5]
include::../DeveloperGuide.adoc[tag=xue6]
