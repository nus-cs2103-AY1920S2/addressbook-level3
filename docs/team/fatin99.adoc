...
for new information to be displayed instantaneously upon entering a command (#189, #210, #212). Doing this involved
creating an enum for UI handling in CommandResult (#189, #212) and as a result, the painstaking process of updating all
...
due to the differences in rates among different faculties. (#321)

=== Other UI Improvements

I also contributed to the development of the HelpWindow and StatisticsWindow (#227, #235) by fixing sizing
...
* Create a skeleton for the student delete command (#113)
* Contribute to StudentAdd command by removing the requirement for compulsory phone and email fields (#146)
