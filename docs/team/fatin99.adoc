...
This contribution also required extensive debugging and contributions to the inner workings of the `FilterCommand`, which
...
* Created a skeleton for the `StudentDeleteCommand` (https://github.com/AY1920S2-CS2103T-W17-4/main/pull/113[#113]
)
* Removed the requirement for compulsory `Phone` and `Email` fields in `StudentAddCommand` (https://github.com/AY1920S2-CS2103T-W17-4/main/pull/146[#146]
)
