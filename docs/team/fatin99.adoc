...
to allow users to switch between tabs via the command-line rather than clicking on the tab-headers (PR #189).

In a similar spirit, I enabled switching to relevant tabs for all commands, to better the user experience. This allows
for new information to be displayed instantaneously upon entering a command (PR #189, #210, #212).
...
I also contributed to the development of the HelpWindow and StatisticsWindow (PR #227, #235) by fixing sizing
issues and adding ScrollPanes. Moreover, I included the option to close both windows by pressing the ESC key to achieve
