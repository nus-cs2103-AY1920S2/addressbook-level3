...
TA-Tracker is a productivity tool made for NUS School of Computing (SoC) Teaching Assistants (TAs). Rather than using
several excel spreadsheets or notes, TA-Tracker enables TAs to manage their students and track teaching duties in a
single, convenient-to-use platform . The application is mainly written in Java and spans a considerable 20,000 Lines of
Code (LoC). With a rigorous system of checks and tests put in place, users can be assured that the codebase is
...
correctly, while keeping the interface simple and informative. The overall layout of TA-Tracker was changed by adding
...
I also took care to ensure that the information displayed in the Cards was integrated with the backend whenever my
...
Earnings" label in Claims tab was also added to improve user experience, as money makes the world go round (https://github.com/AY1920S2-CS2103T-W17-4/main/pull/243[#243]
, https://github.com/AY1920S2-CS2103T-W17-4/main/pull/322[#322]
).

==== Enabled highlighting of applied filters

As the TA-Tracker was initially based on AB3, the UI at the beginning of the project looked plain. Instead of
...
due to the possibility of changes being made to it. (https://github.com/AY1920S2-CS2103T-W17-4/main/pull/321[#321]
)
...
the goal of making TA-Tracker a keyboard-only application (https://github.com/AY1920S2-CS2103T-W17-4/main/pull/236[#236]
).
...
* Created a skeleton for the student delete command (https://github.com/AY1920S2-CS2103T-W17-4/main/pull/113[#113]
)
* Removed the requirement for compulsory phone and email fields in student add (https://github.com/AY1920S2-CS2103T-W17-4/main/pull/146[#146]
)
