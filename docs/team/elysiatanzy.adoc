...
** *What it does:* The model forms the backbone of most commands which require Assignment and the basic commands allow the adding, deleting and editing an assignment
