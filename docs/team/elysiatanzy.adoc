...
*Naggy Joel* allows users to keep track of various aspects of their lives, ranging from their different social circles and contacts, to their events and deadlines. It aims to help the user be the best friend and best student that they can ever be.

== Summary of contributions
=== Major Enhancements:
* *Added the ability to allow users to generate their upcoming schedule*
** *What it does:* Generates the user’s schedule for a specified number of day(s) based on the stored uncompleted assignments, their individual deadlines and estimated completion time.
...
* *Code contributed*: [https://nus-cs2103-ay1920s2.github.io/tp-dashboard/#search=elysiatanzy&sort=groupTitle&sortWithin=title&since=2020-02-14&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=authorship&tabAuthor=ElysiaTanZY&tabRepo=AY1920S2-CS2103-W14-3%2Fmain%5Bmaster%5D[Functional Code]][https://nus-cs2103-ay1920s2.github.io/tp-dashboard/#search=elysiatanzy&sort=groupTitle&sortWithin=title&since=2020-02-14&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=authorship&tabAuthor=ElysiaTanZY&tabRepo=AY1920S2-CS2103-W14-3%2Fmain%5Bmaster%5D[Test Code]]
...
*** Managed releases `v1.1, v1.2.1 to v1.3.1` (4 releases) on Github
** Community:
...
*** Helped team members debug problems and gave suggestions on how to enhance features
*** Reported bugs and suggestions for other teams in the module (https://github.com/ElysiaTanZY/ped/issues?q=is%3Aissue+is%3Aall[1])
