...
(Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/209[#INSERT PRS])
...
(Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/352[#INSERT PR HERE])
...
+
.Bmi Command Sequence Diagram for no input arguments
image::DietTrackerBmiCommandNILSequenceDiagram.png[]
+
.Retrieve Height and Weight from Model for usage in BmiCommand
.Bmi Command Activity Diagram
image::DietTrackerBmiCommandNILSequenceDiagram2.png[]
+
.Bmi Command Sequence Diagram for input arguments
image::DietTrackerBmiCommandSequenceDiagram.png[]
+
.Create Height and Weight Objects for usage in BmiCommand
...
+
.List Command Sequence Diagram for `-a` and No-Flag Input
image::DietTrackerListCommandAllSequenceDiagram.png[]
+
.List Command Sequence Diagram for `-d`
image::DietTrackerListCommandDaySequenceDiagram.png[]
+
.List Command Sequence Diagram for `-t`
...
** Documentation:
*** Updated Developer Guide to include Bmi Command (Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/352[#Change])
*** Updated Developer Guide to include Height Amount Command (Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/355[#change])
*** Updated Developer Guide to include Weight Receipt Command (Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/355[#change])
*** Updated Developer Guide to include Mode Receipt Command (Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/355[#change])
*** Updated Developer Guide to include Metrics Receipt Command (Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/355[#change])
*** Updated Developer Guide Template for Diet Tracker overall (Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/252[#change])
*** Updated User Guide to include Bmi, Height, Weight, Bmi Command (Pull request https://github.com/AY1920S2-CS2103T-W13-1/main/pull/349[#change])
