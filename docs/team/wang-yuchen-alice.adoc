...
|===
|[NOTE]
|_Due to page limit, only selected sections are included. Refer to User Guide for more sections._
|===

//include::../UserGuide.adoc[tag=add]
include::../UserGuide.adoc[tag=edit_find]
...
include::../UserGuide.adoc[tag=edit_findDiary]
