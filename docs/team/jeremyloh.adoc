...
|===
This whole section on "how to navigate user guide" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/UserGuide.html#navigate-user-guide
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../UserGuide.adoc[tag=how_to_navigate_user_guide]

== Features
This whole section on "delete" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/UserGuide.html#delete
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../UserGuide.adoc[tag=delete]

This whole section on "Viewing orders located at the same area or postal sector: nearby" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/UserGuide.html#nearby
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../UserGuide.adoc[tag=nearby]

== Glossary
This whole section on "Command Prefix" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/UserGuide.html#command_prefix
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../UserGuide.adoc[tag=command_prefix]

This whole section on "Command Flags" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/UserGuide.html#command_flags
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../UserGuide.adoc[tag=command_flags]

This whole section on "Area Information of Singapore" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/UserGuide.html#area_table
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
...
== Features
This whole section on "Delete Feature" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/DeveloperGuide.html#delete
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../DeveloperGuide.adoc[tag=delete]

This whole section on "Nearby Feature" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/DeveloperGuide.html#nearby
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
...
== Glossary
This whole section on "Command Prefix" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/DeveloperGuide.html#glossary
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../DeveloperGuide.adoc[tag=command_prefix]

This whole section on "Possible Command Flags" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/DeveloperGuide.html#glossary
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
...
== Use Case
This whole section on "Use case: UC03 - Delete an order" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/DeveloperGuide.html#use-cases
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../DeveloperGuide.adoc[tag=use_case_delete]

This whole section on "Use case: UC12 - Obtain orders in a postal sector" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/DeveloperGuide.html#use-cases
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
...
This whole section on "Deleting an order" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/DeveloperGuide.html#deleting-an-order
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
include::../DeveloperGuide.adoc[tag=appendix-delete]

This whole section on "Obtain all nearby orders based on area or postal sector" can be found at
https://ay1920s2-cs2103t-w12-1.github.io/main/DeveloperGuide.html#obtain-all-nearby-orders-based-on-area-or-postal-sector
This link is provided in the event if some of the cross links are not working, as they refer to documents
done by another team member.
