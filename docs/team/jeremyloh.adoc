...
that allowed me to test more effectively. +
The mapping of postal sectors was done using a *HashMap*.
...
*** Contributed to forum discussions (examples: https://github.com/nus-cs2103-AY1920S2/forum/issues/88[88])
*** Reported bugs and suggestions for other teams in the class (examples:  https://github.com/JeremyLoh/ped/issues[PE dry run issues])
** Tools:
