...
=== Buy goods from supplier: `buy`

Buy a particular goods from the supplier. +
...
Sell a particular goods from the inventory.. +
...
e.g. `delete 3`
* *Edit supplier* : `edit-s INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
