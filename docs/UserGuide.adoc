...
[[show]]
=== Showing statistics : `show`

==== Description
* The statistics displayed will show information about the list of orders assigned to the courier.
It allows courier to see how much earnings he/she has made in one day, number of orders delivered
and the total number of orders to deliver today. There is a PieChart at the bottom that shows the percentage
of delivered orders as compared to the undelivered ones.
...
==== Examples:
* `show` +
Open a window where it contains the statistics.
