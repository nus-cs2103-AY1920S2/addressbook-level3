...
This sections gives an explanation of all the commands that can be used
in the Student View.
...
====
[horizontal]
`NOTES`:: notes for this session (eg: weekly tutorials, prep sessions, consultation with John Doe)
====
