...
.CS2103T is added as a module under the Year 2 Semester 2
image::AddModule.png[width="790"]


TIP: `add m/CS2103T y/2.2 g/A+` +
Adds CS2103T to the list of modules under Year 2 Semester 2 with the resulting grade, A+.
...
with the deadline "25 April 2020 17:00" to the already-existing module CS2101, as shown in Figure 5 below.

.CS2101 task is added into and displayed on the sorted Deadline Panel
image::DeadlinePanel.png[width="790"]

TIP: `add m/CS2105 t/Assignment d/2020-04-20 23:59` +
TO BE EDITED

NOTE: Dates are highlighted and sorted according to the number of days remaining (shown in Figure 5). +
Red: 0 - 5 days +
Orange: 6 - 10 days +
Green: ≥ 11 days
...
Example: `edit n/Brad c/Information Systems` edits your profile name to "Brad" and your course to "Information Systems", as shown in Figure 6 below.
...
Alongside name and course, you can edit your focus area to match your current course.
...
Example: `edit m/CS2103T g/A+` edits your grade of the module CS2103T to A+, as shown in Figure 7 below.

.Module detail of CS2103T edited
image::EditModule.png[width="790"]

TIP: `edit m/CS2103T g/A+` +
Edits your grade of the module CS2103T to A+
...
TIP: `edit m/CS2103T t/tP Submission nt/UG and DG Submission` +
Edits "tP Submission" under CS2103T to "UG and DG Submission"
...
If you want to clear your profile and data from *MODdy*, use this command. It clears all entries from *MODdy*, as shown in the figure below.
