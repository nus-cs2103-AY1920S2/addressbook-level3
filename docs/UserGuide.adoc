...
* `edit` `INDEX` `<<command_prefix, ORDER_ATTRIBUTE_PREFIX>>/NEW_VALUE` `<<command_prefix, [MORE_ORDER_ATTRIBUTE_PREFIXES>>/NEW_VALUE]...`
...
* `return` `tid/a1230512` `n/Aaron Teo` `a/256 Alpha Road #03-222, Singapore 123567` `p/91230456` `ts/12-12-2020` `w/Jurong Warehouse` `pm/visa` `c/Leave it at the lobby` `type/metal` +
