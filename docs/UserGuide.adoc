...
image:demo/New1.png[width="790"]

.Demo for the `new` command (with only title parameter)
image:demo/New2.png[width="790"]

.Demo for the `new` command (final state)
image:demo/New3.png[width="790"]
