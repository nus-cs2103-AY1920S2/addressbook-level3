...
+
.  Type a command in the command box (the box with the `green` words), and press kbd:[Enter] to execute it. +
...
Here is a table outlining how the commands have been formatted in this guide:
...
Also, when you enter a new command, you will be automatically switched to the relevant `tab`
