...
*Features*
   ...
   13. Using a coupon: used
   14. Undoing the previous command: undo
   15. Redoing the undone command: redo
   16. Archiving a coupon: archive
   17. Exporting a coupon: export
   18. Setting user preferences: setpref
...
* *Add:* `add n/name e/EXPIRY DATE s/SAVINGS [u/USAGE] [l/USAGE_LIMIT] [p/PROMO_CODE] [sd/START_DATE] [r/REMIND_DATE] [c/CONDITION] [s/SAVINGS]... [t/TAG]…`​ +
