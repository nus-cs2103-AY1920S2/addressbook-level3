...
[[CAPCalculator]]
=== Calculating your Cumulative Average Point (CAP)

If you want to calculate your CAP, *MODdy* has an in-built CAP calculator feature which automatically updates your CAP when you input
your module grade.
...
image::CAPCalculator.png

// tag::home[]
[[Home]]
=== Returning to Homepage : `home`

If you want to return to *MODdy*'s Homepage, use this command, as shown in the Figure 20 below.
