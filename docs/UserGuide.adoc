...
If you need to look for a note that contains a specific keyword in its *content*, use the `search` command and Notably will show you the search results sorted by the number of matches in the note.  +
