...
* The index *must be a positive integer* 16100, 25200, 55250, ...
****
[TIP]
====
...
* `delete-course 16100`
****
* Edits the item at the specified `ID`. The index refers to the index number shown in the displayed item list
