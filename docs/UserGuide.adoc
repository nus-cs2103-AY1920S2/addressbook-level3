...
open the file up.
. TODO: Sample data... Can clear it if you want
...
screen. <<_archiving_a_coupon_archive, Archived>> coupons will always appear **below** active coupons.
// Put GIF here
...
<<Listing all coupons: `list`, `list`>> command and save it as a `.png` file.
* `find chicken` +
`share 1` +
