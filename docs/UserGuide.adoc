...
Notably will try its best to correct your mistypes automatically, as long as your mistyped inputs are not too far away from the correct commands (`Paths` included too!). This provides you with a more fluid typing experience.
