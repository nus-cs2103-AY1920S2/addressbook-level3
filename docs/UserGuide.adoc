...
=== Timed Session - Coming in V2.0
(Contributed by Haoyi)

In V2.0, you will be able to add timed sessions. Timed sessions include sessions that will notify
and remind you as the sessions start time approaches. Timed sessions also include sessions that can
be started and stopped as they happen, such that their start/end time will no longer need to be
explicitly specific.
