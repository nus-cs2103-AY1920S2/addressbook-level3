...
In this section, you will learn more about the `paid` command, how to use it and the possible usage scenarios of the
`paid` command.

Summary: `paid` subtracts the amount paid by a Person.
