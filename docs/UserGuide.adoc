...
[WARNING]
You must only input one mode per mode command.
[NOTE]
The default mode for any individual who has chosen his/her Dieting Mode will be MAINTAIN.
...
* `metrics` +
Checks your individual health metrics based on what was previously stored.
