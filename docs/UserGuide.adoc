...
Are you someone who often goes out to eat with friends? And do you also sometimes feel that you might be eating too much?
...
Display all the person(s) and the amount they owe.
...
Exits `split` mode to go back to the main menu of the application.
