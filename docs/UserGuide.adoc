...
In this section, you will learn more about the `paid` command, how to use it and the expected outcome after using the
`paid` command.

*Summary: `paid` subtracts the amount a Person owes you.*
...
empty is equivalent to the Person paying you the full amount he owes you.
