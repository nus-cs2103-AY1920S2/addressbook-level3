...
By: `The CookBuddy Team`      Since: `Feb 2020`      Licence: `MIT`
...
Format: `modify <index> [ing/<idx. ingredient, quantity> [ins/instruction; ...] [cal/calories] [s/serving size] [r/rating] [tags/tag, ...]`
