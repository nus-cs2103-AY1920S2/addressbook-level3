...
image::findcIncompleteNamePart1.png[]

Type `find-c bry" into the command box, and press `Enter` to execute it.

image::findcIncompleteNamePart2.png[]

You will obtain "no clients listed!".

image::findcIncompleteNamePart3.png[]
...
image::addeExamplePart1.png[]

2.Now type the information of the exercise, matching each detail of the exercise to the parameter. In this case, you will have to type `add-e n/Bench press d/12-02-2020 reps/4 ew/100 sets/4` into the command box. To recap,
...
image::addeExamplePart2.png[]

3.After it has been successfully entered, the result box will display the recorded exercise. You will also be able to see the recorded exercise in the table.

image::addeExamplePart3.png[]
...
image::addeDuplicatePart1.png[]

If you were to enter `add-e n/Bench Press d/12-02-2020 reps/4 ew/100 sets/2` into the command box, the only information that is different is the number of sets. 

image::addeDuplicatePart2.png[]

The result box will show that you have a duplicate exercise.

image::addeDuplicatePart3.png[]
...
1.Identify the index of the exercise in the exercise table. From the photo above, the index is 2. Type `edit-e 2 reps/4 ew/100` into the command box. To recap,
...
2.After it has been successfully entered, the result box will display a success message that the exercise has been edited. You will also be able to see the edited exercise in the table.
...
If you were to enter `edit-e 2 n/Bench Press d/12-02-2020 reps/4 ew/100 sets/2` into the command box, the only information that is different is the number of sets. 
