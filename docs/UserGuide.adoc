...
b.  `diary show ENTRY_ID` : Shows the diary entry for the specified entry ID.
c.	`diary show DATE` : Shows the diary entry at the specified date if there is any, date needs to be in DD-MM-YYYY
