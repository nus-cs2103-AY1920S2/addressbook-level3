...
Format: `findc [n/NAME [NAME]...] [p/PHONE [PHONE]...] [e/EMAIL [EMAIL]...] [a/ADDRESS [ADDRESS]...]`
...
* Customers matching any keywords in an attribute will be returned (i.e. OR search) e.g. `findc a/clementi ave` will return customers with 'clementi' or 'ave' in their addresses
****
...
Returns all customers with addresses in Serangoon and have Bob in their names.
// end::findc[]
...
image::TransactionTab.png[align="center"]
...
image::StatisticsTab.png[align="center"]
...
image::ViewInventory2.png[align="center"]
