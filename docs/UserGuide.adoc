...
When you first launch FitBiz, you will be greeted by the GUI. In this section, we shall discuss about what each section of this GUI is responsible for.
...
* **Feedback Box**: this is where feedback and other useful information about your commands that you have just entered will be displayed
* **Client List**: this is where all your clients currently recorded in FitBiz will be displayed
* **Schedule List**: this is where all your schedules of your clients will be displayed
* **Client View**: this is where all your information pertaining to the currently viewed client will be displayed
...
[NOTE]
Make sure you know how to view a client first. Refer to <<view-c-command>> for more information.
