...
. You will find the recurring period `[w/WEEKS]` field handy for tasks that will happen every week
...
be created with `DATE d/2020-20-20` (2 weeks later from the date of the original session)
** `MOD_CODE` of CS2103T
** `TYPE` consultation
