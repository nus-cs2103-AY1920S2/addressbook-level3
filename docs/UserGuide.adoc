...
To switch views, HireLah! also provides these commands.
...
_Action_: Generates the report of Jane Doe in the form of a PDF.

_Output_:

....
Report of Jane Doe generated.
....
...
e.g. `open Jane Doe`
* Generate report of an interviewee: `report <interviewee>`
