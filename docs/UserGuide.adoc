...
.  Download the latest `CS2103T-W12-1.Delino.jar` link:{repoURL}/releases[here].
.  Copy the file to the folder you want to use as the home folder for your Delino.
.  Double-click the file to start the app. The GUI should appear in a few seconds.
.. If you are a Mac user and are unable to open the jar file after double-clicking,
please open Terminal and change the directory to the directory that the
jar file was downloaded at.
Then, type the following command to open the Delino application: +
`java` `-jar` `CS2103T-W12-1.Delino.jar`
.. If you are a Windows user and are unable to open the jar file after double-clicking,
please open Command Prompt and change the directory to the directory
that the jar file was downloaded at.
Then, type the following command to open the Delino application: +
`java` `-jar` `CS2103T-W12-1.Delino.jar`
