...
Format: `addt p/PRODUCT_ID c/CUSTOMER_ID dt/DATETIME q/QUANTITY m/MONEY [d/DESCRIPTION]` +

Examples:

* `addt p/1 c/10 dt/2020-02-19 19:00 q/10 m/20` +
Adds a transaction with product 1 and customer 10 of 20 dollars for 10 products at 2020-02-19 19:00.
* `addt p/20 c/2 dt/2020-02-20 10:00 q/10 m/30 d/under discount` +
Adds a transaction with product 20 and customer 2 of 30 dollars for 10 products at 2020-02-20 10:00.
...
* `lowlimit p/1 t/20` +
Sets the low inventory threshold for product 1 as 20.
...
* *Locating customers* : `findc [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
e.g. `findc n/John`
