...
Edits the 2nd event in CS2013T event-list end date to be `12-12-2020 23:59`.
* `edit-e 3 m/CS2030 n/Finish LAB level 3 with Generics sd/20-05-2020` +
Edits the notes and start date of the 3rd event in CS2030 event-list to `Finish LAB level 3 with Generics` and `20-05-2020 23:59` respectively.
...
** Lexicographical order (case-insensitive): `name` +
** Date added: `date` +
** Priority: `priority`

The sort order is fixed from top to bottom, as follows:

** Lexicographical order (case-insensitive): A to Z +
...
** `sort name` +
Sorts by case-insensitive, lexicographical order of the activity's name.
