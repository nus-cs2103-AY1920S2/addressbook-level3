...
This user guide aims to provide you with essential information on how to use MODdy. With the the following features of *MODdy*,
...
. Create your own profile by entering your details in the command box using these parameters: `new n/NAME c/COURSE y/YEAR.SEMESTER [f/FOCUS_AREA]`
...
* Parameters must follow this order: `m/MODULE`, `y/YEAR.SEMESTER`, `g/GRADE`, `t/TASK`, `d/DEADLINE`
====
