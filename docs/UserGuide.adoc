...
You *must* give either a `-o` flag for viewing nearby orders in the order list
...
A `FLAG` refers to either `-o` or `-r`. +
...
* `nearby` `-o` `north` +
You will view all orders in the order list located in the north area of Singapore.
