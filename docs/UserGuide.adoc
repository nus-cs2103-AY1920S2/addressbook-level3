...
This sections gives an explanation of all the commands that can be used with the Student
View.
...
[NOTE]
====
You should ensure that no module with the module code that you're adding exists
in the TA-Tracker before-hand.
====
...
[NOTE]
====
You should ensure that a module with the given module code exists in the TA-Tracker before
...
[NOTE]
====
You should ensure that a module with the given module code exists in the TA-Tracker
before you attempt to edit it.
====
...
* You should ensure that the module doesn't contain a group with the given group code
beforehand.
====
...
* A group with the given group code should exist inside the module before you attempt to edit it.
...
orts the students inside all the groups of the module you want to sort according
