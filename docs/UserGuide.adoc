...
Format: `(ev)edit [t/EVENT_TITLE] [dt/EVENT_DATE] [d/DURATION] [p/PLACE]`
...
* `(ev)edit 2 dt/2020-04-25 22:00 d/2` +
Edits the 2nd event in the Event Schedule by changing the timing to 10PM on the 25th of April and the estimated duration to be 2 hours.
...
** `(ev)add t/EVENT_TITLE dt/EVENT_DATE d/DURATION p/PLACE`
* *Delete* :
** `(ab)delete INDEX`
** `(rt)delete INDEX`
** `(st)delete INDEX`
