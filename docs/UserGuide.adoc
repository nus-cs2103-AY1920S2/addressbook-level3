...
a.	`notes ops/list loc/NUS/`: shows content in usr/NUS/ folder, content will be updated in the UI
b.	`notes ops/open loc/Desktop/test.doc`: Opens the file test.doc at usr/Desktop, if file is not present, error message will be shown.
c.	`notes ops/create loc/Desktop/test.doc`: Creates the file test.doc at usr/Desktop, if file is already present, error message will be shown.
