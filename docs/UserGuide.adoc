...
==== Managing your tasks separately for each module

[WARNING]
For this part, the UI hasn't been implemented yet so that you can only view your tasks in Calendar tab stated above.

.  Creating a module task : `moduleTask`

- Adds a task related to certain module you have added before.
...
****
* This command allows you to create tasks specific to certain module you added to the program before.
