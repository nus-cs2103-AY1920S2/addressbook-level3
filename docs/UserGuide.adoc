...
All your recipe information is stored on our simple and clean Graphical User Interface (GUI) and we are optimized for users who are very comfortable with working on the Command Line Interface (CLI).
...
*A*: No. Please do not modify the data folder of your CookBuddy. All modifications of the recipes should be done through the `modify`command only.
