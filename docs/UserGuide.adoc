...
*A*: You can do so by first installing TA-Tracker in another computer. You can then replace
...
*A*: You can do so by entering `clear` into TA-Tracker or by deleting `TA-Tracker.json`. Do take note
...
*A*: Simple delete the folder where you have placed TA-Tracker in.
...
*A*: Yes you can. Simple copy the `.jar` file into a different folder and run the app there. You will then be able
