...
*Features*
   ...
   10. Saving the data
   11. Adding a reminder: remind
   12. Viewing savings: saved
   13. Use a coupon: used
   14. Undo the previous command: undo
   15. Redo the undone command: redo
   16. Archive a coupon: archive
   17. Export a coupon: export
   18. Set user preferences: setpref
...
You should be!!!! Jump to the Section 2, “Quick Start” to get started. Enjoy!
...
s/SAVINGS, s/SAVINGS n/NAME is also acceptable.
...
Format: +
`remind INDEX r/(specific date to remind)`
...
display coupons' savings, to € (Euro).
