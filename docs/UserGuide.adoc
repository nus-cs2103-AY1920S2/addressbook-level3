...
+
Show an image of CookBuddy here.
...
Example 1: You can enter `new n/Fried Rice ing/White rice, 1 cup; salt, 1 gram ins/Fry the rice; add salt p/C:\Users\zain_\Downloads\friedrice.jpg` into *CookBuddy*, and a new recipe with the following attributes will be added:
