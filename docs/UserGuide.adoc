...
Format: `add n/name e/EXPIRY DATE s/SAVINGS [l/limit] [p/PROMO CODE] [sd/START DATE] [r/REMIND DATE] [c/CONDITION] [t/TAG]`
...
* `add n/The Deck Chicken Rice d/20% off sd/5-5-2020 e/6-5-2020 t/value`
...
Format: `edit INDEX [n/name] [e/EXPIRY DATE] [s/SAVINGS] [l/limit] [p/PROMO CODE] [sd/START DATE] [r/REMIND DATE] [c/CONDITION] [t/TAG]`
...
Yes, you can. Use the ``Add'' command and type in all your coupons
in this format, +
add n/Co-op s/25% off on all stationeries sd/25-2-2020 e/30-8-2020 t/value
t/stationaries +
n/PGP Mala s/10% off sd/2-3-2020 e/30-8-2020 t/value t/friends +
n/Universal Studios theme part s/50% off for all students sd/2-5-2020
e/1-1-2021 t/value +
{empty} +
...
e.g. `add n/The Deck Chicken Rice s/20% off sd/2-3-2020 e/30-8-2020 t/friend t/value`
* *Clear*: `clear`
* *Delete*: `delete INDEX` +
e.g. `delete 3`
* *Edit*: `edit INDEX [n/name] [e/EXPIRY DATE] [s/SAVINGS] [l/limit] [p/PROMO CODE] [sd/START DATE] [r/REMIND DATE] [c/CONDITION] [t/TAG]`​ +
e.g. `edit 2 n/Chicken Up s/50% off`
