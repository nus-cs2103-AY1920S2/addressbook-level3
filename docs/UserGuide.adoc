...
Exports a coupon as an `add` command to your clipboard so that you can easily share it with your friends/ family! 
...
****
****
NOTE: The exported add command will only contain the following fields: 
* Name
* Savings
* Expiry Date
* Limit
