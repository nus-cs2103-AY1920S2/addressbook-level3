...
[TIP]
You can *delete, <<UserGuide.adoc#Favourite a recipe: `favourite`,favourite>>, or
<<UserGuide.adoc#Unfavourite a recipe: `unfavourite`,unfavourite>>* multiple recipes at the same time
(at least one recipe must be selected).
