...
1.Identify the index of the exercise in the exercise table. From the photo above, the index is 2. Type `edit-e 2 reps/8 ew/50` into the command box. To recap,
