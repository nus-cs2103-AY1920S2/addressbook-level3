...
* Start a workout completedExercise which guides you through your workout routines
* Schedule your workout completedExercises and receive timely reminders
...
The application will close gracefully, and all data in the current usage will be saved in the data directory. If the command is executed successfully, you should see the following message before the application closes:
...
You are now an expert in managing your workouts, and can start a workout any time! However, wouldn’t you like to have the ability to schedule your workout completedExercises? In this section, we will guide you to learn how ZeroToOne can help you in this aspect!

==== Scheduling a new workout completedExercise

To schedule a new workout completedExercise, simply type in this command:
...
.Scheduling a workout completedExercise
...
==== Listing all future scheduled completedExercises

To view all of your future schedule completedExercises, type the following command:
...
ZeroToOne displays an intuitive calendar view, showing your upcoming schedule! From this graphical view, you can see what workout completedExercises are coming up, as well as their corresponding schedule IDs.

==== Changing a scheduled completedExercise to another date

If you need to shift your scheduled completedExercise to another date, try the following command:
...
```
Example use:
schedule edit 1 d/2020-02-08 18:00
```
...
==== Deleting a scheduled completedExercise

Want to delete a scheduled completedExercise? You can do so by typing the following command:
...
This deletes an existing scheduled workout completedExercise with the corresponding scheduled workout ID. If this is successful, the following message will be displayed in the feedback display:
...
==== Scheduling a recurring workout completedExercise (Proposed)

Sometimes you will want to schedule a workout completedExercise that repeats over time, with a certain frequency. No problem! Simply type the following command:
...
```
Example use:
schedule recurring create WORKOUT_ID d/2020-03-26 10:00 f/MONTHLY
```

For example, if you want to have the workout Arms Workout on a monthly basis, starting from the 26th of March 2020 at 10am, you can type `schedule recurring create WORKOUT_ID d/2020-03-26 10:00 f/MONTHLY`.  If this is successful, the following message will be displayed in the feedback display:
...
You have successfully gone through the whole process of managing your workouts and scheduling them, good job! To take it one step further, ZeroToOne also allows you to log your past completed workout completedExercises. Read on to learn how!

==== Viewing your logs
To view a list of all your logged past workout completedExercises, simply type the following command:
...
```
Listed 1 logged workout completedExercise(s)!
```

==== Deleting a logged completedExercise

Want to delete a logged workout completedExercise? Simply type in the following command:
...
The view will automatically update with the updated list of logged completedExercises. If this is successful, the following message will be displayed in the feedback display:
...
```
NOTE:
* LOG_ID refers to the index of the logged past workout completedExercise in `log list`
```
