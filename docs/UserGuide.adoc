...
this user guide..
.. You can use the up and down arrow keys to navigate through previous
executed commands.
...
your clipboard. Simply Ctrl + V to paste it! (Cmd + V for macOS)
****
// Put GIF
...
* <<Unarchive a coupon: `unarchive`, `unarchive`>>
