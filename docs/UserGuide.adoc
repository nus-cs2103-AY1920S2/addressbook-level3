...
Example: `add n/Chicken Rice t/30 ip/300g, Chicken Thigh ig/300g, Rice s/Boil chicken s/While chicken is cooking,
          ...
          s/Serve while rice is hot g/Bulk like the Hulk` +
...
[TIP]
If you specify a recipe number that does not exist in the list of recipes that you are currently viewing, none of your
