...
i.e. `return` `tid/123abcd` +
 or +
`return` `tid/A999999` `n/John Doe` `p/98765432` `a/311 Clementi Ave 2 #02-25` `e/johndoe@gmail.com`
...
* If there are 2 or more `ORDER_TYPE` within a single order sentence it will be treated as 2 or more orders.
