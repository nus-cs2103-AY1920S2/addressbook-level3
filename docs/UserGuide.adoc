...
* Parameters must follow this order: `m/MODULE`, `y/SEMESTER_TAKEN`, `g/GRADE`, `t/TASK`, `d/DEADLINE`, `s/STATUS`, although some are optional.
====
...
****
* `g/GRADE` is compulsory if module is completed.
...
Format: `add m/MODULE y/SEMESTER_TAKEN [g/GRADE] t/TASK d/DEADLINE s/STATUS` +
If the module is existing, +
Format: `add m/MODULE t/TASK d/DEADLINE s/STATUS`
...
* `add m/CS2107 t/Assignment d/2020-03-31 23:59 s/not done`
