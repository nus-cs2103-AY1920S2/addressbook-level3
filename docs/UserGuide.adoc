...
Adds a new note about the food to a restaurant +
Format: `(rt)addnote INDEX [r/RECOMMENDED_FOOD] [g/GOOD_FOOD] [b/BAD_FOOD]`

Examples:

* `(rt)addnote 2 r/chicken chop g/truffle fries b/risotto` +
Adds a notes to an existing restaurant in the list that is indexed 2 with recommended food Chicken Chop, good food Truffle Fries, and bad food Risotto.
...
* `(st)add t/CS2103 post lecture quiz d/2020-02-11 2359 e/1` +
...
* All remarks and tags will be deleted if specified.
****
