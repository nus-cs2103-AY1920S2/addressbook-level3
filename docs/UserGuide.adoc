...
* You can use multiple keywords in `NAME`. +
e.g. You can type `find-c bryan low`.
...
* The keywords in `NAME` have to match at least one word in the name of the clients. +
