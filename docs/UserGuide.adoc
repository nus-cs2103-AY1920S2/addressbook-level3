...
== Quick Start
Follow the steps below to get started with Coupon Stash!
...
* `delete 1` +
  `undo` +
  `redo` +
Un-undo the <<Deleting a coupon: `delete`, `delete`>> command. First coupon that was in the resulting coupon list is deleted.
// end::redo[]
