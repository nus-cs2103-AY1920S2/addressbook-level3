...
Listing the amount of money each Person owes you.

OR

If you want to find how much each Person(s) owes you!

*Summary of List Amount Command: `listamount` shows you how much each Person owes you*.

*How to use the List Amount Command:*

Format of List Amount Command: +
`listamount` +

Example of valid List Amount Command: +
`listamount`
...
*Additional tips and notes for List Amount Command* +
