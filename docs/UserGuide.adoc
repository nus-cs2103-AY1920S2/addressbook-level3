...
Jump to <<Quick Start>> to get started. Hope you enjoy the company of MODdy!
...
* **`add`**`m/CS2103T y/1` : adds CS2103T into your Module List under Year 1 Semester 1
...
* Only one profile is allowed. Changing profile fields are to be done using the `edit` command. If you wish to create a new profile, please remove it with the <<Delete,`delete`>> feature mentioned in 4.6.
****
...
This command clears all entries from MODdy including your profile and its data.
