...
The order will persist throughout the runtime of the program. The command will sort any coupons currently on screen.
For example, sorting after finding will sort all the found coupons. (including archived ones, which will appear at the bottom)
