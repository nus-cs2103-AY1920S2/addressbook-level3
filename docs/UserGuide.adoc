...
==== Removing tags from a person : `(ab)rmtag`
...
Format: `(rt)addnote n/NAME [r/RECOMMENDED_FOOD] [g/GOOD_FOOD] [b/BAD_FOOD]`

Examples:

* `(rt)addnote rubbish r/chicken chop g/truffle fries b/risotto` +
...
==== Visualise the intensity of user's upcoming schedule: `visualise schedule`
...
****
* Only the schedule for the next 7 days (including today) will be shown
