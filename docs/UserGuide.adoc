...
<<coupon-stash-monthyear-format, MonthYear>>.
...
* The <<coupon-stash-date-format, date>> or <<coupon-stash-monthyear-format, MonthYear>> must follow the
...
* `list` +
`copy 2` +
Copies the 2nd coupon in the coupon stash to an
<<Adding a coupon: `add`, `add`>> command and copies it to
your clipboard.
* `find chicken` +
`copy 1` +
Copies the 1st coupon in the results of the
...
Now you can post your coupons on Instagram!
...
* `find chicken` +
`share 1` +
Shares the 1st coupon in the results of the
