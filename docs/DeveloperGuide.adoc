...
image::activityDiagramAutomation2.png[]
...
ModelManager#sortList.

==== Implementation
To sort deadlines, the command will use the keyword `sort` followed by the flag `/sm`, then the sort criteria.
