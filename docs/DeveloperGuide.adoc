...
* *Alternative 1 (current choice):* Edit `Profile`, `Module` or `Deadline` object with one delete command.
...
* *Alternative 2:* Have separate command to edit `Profile`, `Module` and `Deadline`.
