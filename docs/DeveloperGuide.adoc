...
// DONE add diagram of how TaskListPanel is referencing FilteredList and FilteredList references TaskList which contains SortedList that is aware of the UniqueTaskList
...
==== Updating UI
image::SortUpdateUi.png[] // DONE add in sequence diagram
...
// TODO activity diagram for calculation of edit distance
