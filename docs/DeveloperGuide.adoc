...
// TODO what checks? clarify
==== Sort field Completion
Sort field completion is performed by iterating through all arguments and performing the auto complete checks between a user's input word and all possible sort fields.
...
//TODO add functionc calls to stringUtil
