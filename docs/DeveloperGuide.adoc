...
. User requests to [.underline]#go to the `Student Tab` (UC02)# to view
...
1.  User requests to add a new group.
2. TA-Tracker shows adds a new group linked to the specified module.
