...
* 2a. Invalid or empty index keyed into command.
** 2a1. EYLAH requests user to re-enter index in correct format
** 2a2. User enters delete item in  correct format +
...
* 2b. No additional tags and data keyed in as flags to replace existing data.
** 2b1. EYLAH requests user to re-enter command with at least one flag
** 2a2. User enters command with flag and data +
Steps 2b1-2b2 are repeated until the correct  entered is correct. +
Use case ends.
