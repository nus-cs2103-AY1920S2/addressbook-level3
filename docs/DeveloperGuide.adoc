...
.. Add Command Syntax: `add *TRANSACTION_ID* *NAME* *ADDRESS* *PHONE_NUMBER* *DELIVERY_DATE_&_TIME* *WAREHOUSE_LOCATION* *PAYMENT_METHOD* *COMMENTS_BY_CUSTOMER* *TYPE_OF_ITEM*`
