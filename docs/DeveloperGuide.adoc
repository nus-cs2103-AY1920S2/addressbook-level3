...
[NOTE]
An Order class consists of ten different fields as shown in the image. Every order is part of a UniqueOrderList and
every UniqueOrderList is part of an OrderBook. +
Similarly, a ReturnOrder class consists of nine different fields as shown in the image. Every return order is part of a
UniqueReturnOrderList and every UniqueReturnOrderList is part of a ReturnOrderBook.
//end::design_model[]
