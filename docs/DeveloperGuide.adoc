...
is taken from the salary of the teacher.

To pay for `admin`, user has to do it manually using miscellaneous `FinanceType`. To pay for `teacher` b

Certain approaches have some certain pros and cons. It depends on how the user want to pay to `teacher` and `admin`.
