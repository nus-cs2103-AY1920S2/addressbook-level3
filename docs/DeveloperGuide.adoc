...
This feature allows users to save their previously entered commands and to retrieve them using the kbd:[&uarr;] and kbd:[&darr;] arrow keys, similar to what most modern CLIs offer.
