...
|`* *` |user|view records of food consumption or exercise workout in ascending/descending order of calorie |know which days I took in more/less calorie and which days I burned more/less calorie
...
|n/
|Name
|addX, editX, recordprofile

|t/
|Time in format of *yyyy-mm-dd-24-60*
|addX, editX
...
|list, listX, reminder, reminderX, edit, editX, deleteX, periodstart, periodend

|dr/
|Duration in format of *yyyy-mm-dd yyyy-mm-dd*
|list, listX, reminder, reminderX, weightgraph
