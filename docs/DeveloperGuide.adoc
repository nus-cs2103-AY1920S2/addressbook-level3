...
==== Prefix Completion
// DONE Add/edit activity diagram

==== Index Completion
// DONE activity diagram for this
...
==== Auto Complete UI
// DONE add sequence diagram of how it is updated
...
// DONE activity diagram for calculation of edit distance
