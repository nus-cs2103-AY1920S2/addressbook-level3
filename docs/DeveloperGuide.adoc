...
[none]
* 1b. Delino could not find order with the transaction id.
+
[none]
** 1b1. Delino display order not found.
+
Use case ends.

[discrete]
=== Use case: UC08 - Find an order
...
.  System should be able to hold up to 350 orders without a noticeable sluggishness in performance for typical usage.
.  A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.
.  System should be able to respond within two seconds
