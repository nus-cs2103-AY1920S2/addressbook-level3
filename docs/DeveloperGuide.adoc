...
The UniqueSessionList contains a list of all the done sessions associated with the module. This list
is used in the TSS view.
...
6. The AddModuleCommand object checks whether a module with the given module code
already exists in TA-Tracker. If it does, a command exception is thrown saying that
a module with the given module code already exists in the TA-Tracker.
...
exist, the module is removed from the TA-Tracker.
