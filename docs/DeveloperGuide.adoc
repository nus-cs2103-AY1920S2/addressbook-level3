...
|`*` |Temasek Hall resident |want to keep track of my expenses accurately |so I can calculate the exact amount I should collect from my friends after each time we split a meal.
...
[none]
* 1b. EYLAH detects invalid syntax in a Person's details. For instance, a Person's name cannot begin with numbers.
+
[none]
