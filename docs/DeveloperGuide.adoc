...
* The _Sequence Diagram_ below shows how the components interact with each other for the scenario where the user want to add a task in our program.

.Sequence diagram for Adding tasks
image::AddDeadlineSequenceDiagram.png[width="790"]
