...
image::AddCommandSequenceDiagram.png[]

The following sequence diagram shows how the `add` operation works with the input: `add m/CS2105 y/4 t/Assignment 2 d/2020-04-12 23:59`
...
** Cons: Bugs in `deadline` related method calls
