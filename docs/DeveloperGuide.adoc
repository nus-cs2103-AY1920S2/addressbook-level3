...
command to the `StudentCommandParse`r.
...
*Session View* is the term used to call the view that contains a list of all sessions
that haven't been completed yet.

==== Model Framework

The following class diagram shows how different classes are related in the functioning
of the *Session View* alongside the classes used in *Student View*.
...
==== Implementation
This section describes in the implementation of the filter command.
