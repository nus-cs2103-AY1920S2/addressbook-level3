...
.. Test case: `(ev)edit 1 dt/2020-04-25 11:00 d/2` +
   Expected: Edits the first event in the Event Schedule by changing the timing to 11AM on the 25th of April and the estimated duration to be 2 hours.
.. Test case: `(ev)edit dt/DATETIME` (where DATETIME is before the current date and time) +
