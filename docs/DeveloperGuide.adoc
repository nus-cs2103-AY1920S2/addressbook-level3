...
* has a need to manage a significant amount of information on modules
...
`deadline CS2103T /d 01-03-2019 23:59 /t Homework [/n This are the notes.]`
...
`event CS2103T /d 01-03-2019 23:59 /t Project Work [/n This are the notes.]`
2.  NASA will provide a acknowledgement messages.
3.  NASA will displays a list of all the items inside the modules
+
Use case ends.
...
1.  User requests to add an event for a particular module. +
`lesson CS2103T /d 01-03-2019 23:59 /t Tutorial [/n This are the notes.]`
2.  NASA will provide a acknowledgement messages.
3.  NASA will displays a list of all the items inside the modules
+
Use case ends.
...
`edit CS2103T 12 /d 01-04-2019 23:59 /p 5`
2.  NASA will provide a acknowledgement messages
3.  NASA will display the module and it's items.
+
Use case ends.
...
`chedit 12 2 /n new notes messages here`
