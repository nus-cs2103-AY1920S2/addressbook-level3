...
6. LogicManager calls DeleteGroupCommad's execute method. The DeleteGroupCommand object
checks whether a module with the given module code already exists in TA-Tracker.
...
7. If the module exists, the DeletGroupCommand object retrieves the module from the
