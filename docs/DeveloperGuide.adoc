...
|`* *` |user|view records of food consumption or exercise workout in the order of calorie |know which days I took in more calorie and which days I burned more calorie
