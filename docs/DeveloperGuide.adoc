...
[[Design-Ui]]
=== UI component (Contributed by Fatin)
...
[[Design-Model]]
=== Model component (Contributed by Fatin)
...
[[Implementation-Goto]]
=== Goto Command (Contributed by Fatin)
...
==== Model Framework (Contributed by Fatin)
...
=== Claims View (Contributed by Fatin)
