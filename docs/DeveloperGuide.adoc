...
image::CalendarSequenceDiagram.png[width=200%]
...
to add first 3 `CalorieDatum` whose name matches the keyword `swim` into a List, and return the
...
The detailed searching mechanism is illustrated as the following:
