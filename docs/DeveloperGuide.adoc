...
*API* : link:{repoURL}/src/main/java/seedu/address/searcher/Search.java[`Search.java`]

The `Search` Component

* Uses `NUSmods` API to get module info in json format
...
* `Search.findModule()` function returns `Module` Object
* `Module` Object contains module information:
** title
** code
** credits
** workload
...
* `Classes` are represented with their own Object
