...
of a good’s name and a selling price. Good-price pairs are stored as an offer object in the InventoryManager. The following is a class diagram of Supplier feature.

.Class diagram of `Supplier` Feature, displaying only directly related classes
image::SupplierModelClassDiagram.jpg[]
...
3.  InventoryManager confirms the deletion.
4.  InventoryManager deletes the good from the supplier's good list.
+
Use case ends.
