...
|`* * *` |user |edit a homework |quickly change the details of the homework without creating a new entry and deleting the old one
...
|`* * *` |user |add a homework to course |

|`* * *` |user |add a list of homework to course |quickly add all homeworks to a course without going through them one by one
