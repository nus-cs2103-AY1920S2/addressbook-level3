...
|`* * *` |beginner at cooking |easily search for recipes with the ingredients I already have |use up all the food in my fridge
...
|`* * *` |user with allergies |exclude allegic ingredients | obtain recipes that are catered to me.

|`* * *` |demotivated user |choose a goal for myself | cook more meals and be motivated by my progress.

|`* * *` |busy student |preselect meals for the week | save time deciding on what to eat each day.

|`**` |clueless user |ask for suggested recipes | chose a random recipe to start cooking.

|`*` |student on budget |choose recipes that require lower cost| save money

|`*` |user with many recipes in the recipe book |filter recipes by ingredients |locate a recipe easily
...
+
[none]
** 3c1. HealthyBaby shows an error message.
+
Use case resumes at step 1.
...
+
[none]
** 3a1b. HealthyBaby shows an error message.
+
Use case resumes at step 2.
