...
`Main` has two classes called link:{repoURL}/src/main/java/fithelper/Main.java[`Main`] and link:{repoURL}/src/main/fithelper/address/MainApp.java[`MainApp`]. It is responsible for,
...
=== Store calorie data input by the user [proposed in v2.0]
...
.Additional Storage Class responsible for storing user data (existing storage classes omitted)
