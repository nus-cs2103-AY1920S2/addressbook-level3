...
|`* * *` |user with allergies |exclude allergic ingredients |obtain recipes that are catered to me
...
|`*` |frequent party host |easily scale up the ingredients needed for a recipe |make the correct amount of food
