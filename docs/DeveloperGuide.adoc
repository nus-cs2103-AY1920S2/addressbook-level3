...
. NasaBook will load every module in the module list and update each module by the Scheduler.
.. If scheduler sees `0` nothing will be done and the module will get deleted.
