...
. Adding a group to a module. You will be switched to the `Student Tab`.
...
. Adding a student to a group. You will be switched to the `Student Tab`.
...
`CS1101S`. The students inside the group will be unchanged. You will be switched to the `Student Tab`.
...
but the groups and students inside it will remain intact. You will be switched to the `Student Tab`.
...
of the group at index 1 of the module's group list. You will be switched to the `Student Tab`.
...
at index 1 of the module list. You will be switched to the `Student Tab`.
...
of the module `m/CS1101S`. You will be switched to the `Student Tab`.
...
`CS1101S`. The students inside the group will be deleted. You will be switched to the `Student Tab`.
...
You will be switched to the `Session Tab`.
...
period. The session marked as done will be added to the claims list. You will be switched to the `Claims Tab`.
...
. Filtering sessions based on keywords. You will be switched to the `Session Tab`.
...
(aka claims) associated with the module `CS1101S`. You will be switched to
the `Claims Tab`.
...
groups, students and sessions related to this module. You will be switched to
the `Student Tab`.
.. Test Case: `module delete m/CS1101S` +
