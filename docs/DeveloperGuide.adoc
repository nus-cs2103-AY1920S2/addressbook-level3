...
We understand that as certain codes were reused, the estimated effort for this section might be slightly lower. However, we had to create a lot more classes to develop MODdy's features. Bugs also often arose during the actual implementation from our discussions and we had to spend time fixing our own bugs, while also keeping out an eye for bugs from other features that our group mates may have missed out on.


=== Documentation of MODdy

Estimated effort: 11

Using the existing User Guides and Developer Guides of AB3 as a skeleton for MODdy's own guides made it slightly easier to document our application. However, estimated effort is still slightly higher than AB3 as our extensive list of features also required much more documentation.
