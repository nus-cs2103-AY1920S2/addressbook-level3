...
* If the `Assignment` is *not due* on the query date: `Workload` will be allocated in an incrementally.
...
[.text-justify]
*Step 4*: Based on the results, the user can decide on how to best schedule his outing.
