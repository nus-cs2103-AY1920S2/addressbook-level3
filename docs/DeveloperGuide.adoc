...
1.  User sees all homework using UC2.
3.  CCX outputs the whole list of homework.
2.  User requests to edit a homework using its respective homeworkID.
3.  CCX finds for the specific homework using UC4.
4.  CCX changes the details of the homework.
5.  CCX outputs a success message with the updated details for the homework
+
Use case ends.
...
* 2b. New deadline provided is not properly formatted.
[none]
** 2b1. CCX shows an error message.
+
Use case ends.

* 2c. No new details are provided.
[none]
** 2c1. CCX shows an error message.
+
Use case ends.
