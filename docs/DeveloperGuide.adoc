...
==== Parser for Workouts
I will go on to explain the Parser structure for workouts. For the sake of brevity, I will not elaborate on the Command structure for workouts, as it has the same hierarchy as the Parser structure.
