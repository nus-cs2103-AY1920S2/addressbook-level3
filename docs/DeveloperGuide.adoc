...
. If it does exist, *first all the sessions linked to that module are removed*, then the module
...
* 1a. The input required (e.g. Matric Number) to add a student is invalid.
+
[none]
** 1a1. TA-Tracker shows an error message.
+
