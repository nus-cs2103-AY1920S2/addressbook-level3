...
. Obtain using this newly created compositeID, call modelManager#get(ID id, entity.type)
...
There were two main considerations when implementing `Progress` objects.
