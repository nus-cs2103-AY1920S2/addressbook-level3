...
.Additional classes associated with FitHelper for storing user-defined data (existing classes associated with FitHelper omitted)
image::AdditionalModel.png[test, 50%]

.Additional Storage Class for writing and reading user-defined data (existing storage classes omitted)
image::AdditionalStorage.png[test, 40%]
