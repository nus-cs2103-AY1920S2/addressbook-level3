...
The `add` command was implemented as `AddCommand` in the `diettracker/logic` package.
...
Figure : Add Command Activity Diagram
...
Figure: Add Item Command Sequence Diagram

image::DietTrackerAddCommandSequenceDiagram2.png[]
Figure: Execution of Add Item Command
...
The `delete` command was implemented as `DeleteCommand` in the `diettracker/logic` package.
...
Figure: Delete Command Activity Diagram
...
Figure: Delete Item Command Sequence Diagram

image::DietTrackerDeleteCommandSequenceDiagram2.png[]
Figure: Execution of Delete Item Command
...
The `list` command was implemented as a `ListCommand` in the `diettracker/logic` package.
...
Figure : List Command Activity Diagram
...
Figure : List Sequence Diagram for `-a` or No-Flag Input

image::DietTrackerListCommandDaySequenceDiagram.png[]
Figure : List Sequence Diagram for `-d`

image::DietTrackerListCommandTagSequenceDiagram.png[]
Figure : List Sequence Diagram for `-t`
...
The `edit` command was implemented as `EditCommand` in the `diettracker/logic` package.
...
Figure: Edit Command Activity Diagram
...
The `bmi` command was implemented as `BmiCommand` in the `diettracker/logic` package.
...
Figure : Bmi Command Activity Diagram
...
The `height` command was implemented as `HeightCommand` in the `diettracker/logic` package.
...
Figure : Height Command Activity Diagram
...
Figure: Height Command Sequence Diagram
...
The `weight` command was implemented as `WeightCommand` in the `diettracker/logic` package.
...
Figure : Weight Command Activity Diagram
...
Figure: Weight Command Sequence Diagram
...
The `mode` command was implemented as `ModeCommand` in the `diettracker/logic` package.
...
Figure : Mode Command Activity Diagram
...
The `metrics` command was implemented as `MetricsCommand` in the `diettracker/logic` package.
...
Figure : Metrics Command Activity Diagram
...
Figure: Metrics Command Sequence Diagram
...
Figure : Add Item Command Activity Diagram
...
Figure: Delete Item Command Activity Diagram
...
The `listreceipt` command was implemented as a `ListReceiptCommand` in the `expenseSplitterLogic` package.
...
[NOTE]
====
* Each entry in the receipt has the item’s name, price and person(s) who is splitting that item with you
thus you do not have to remember who you split this item with!
...
Figure : List Receipt Command Activity Diagram
...
3. The method `receipt.toString()` will use StringBuilder to print the Items(s) currently in
Receipt by calling `entry.toString()`.

*Sequence Diagram for List Receipt Command*

image::ExpenseSplitterListReceiptCommandSequenceDiagram.png[]

Figure : List Receipt Sequence Diagram
...
The `listamount` command was implemented as a `ListAmountCommand` in the `expenseSplitterLogic` package.
...
Figure : List Amount Command Activity Diagram
...
Figure : List Amount Sequence Diagram
...
The `clearreceipt` command was implemented as `ClearReceiptCommand` in the `expenseSplitterLogic` package.
...
Figure: Clear Receipt Command Activity Diagram
...
Figure: Clear Receipt Command Sequence Diagram
