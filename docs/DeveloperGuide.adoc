...
[[help-interactions]]
==== Sequence Diagram for the Help Feature
...
based on the <<command_prefix, `FLAG`>> provided, -o or -r respectively and <<command_prefix, `INDEX`>>.
2.  Delino changes the delivery status of the specified order or return order to delivered.
...
[none]
* 1b. Delino unable to detect any parcel with the <<command_prefix, `INDEX`>> provided.
[none]
...
[none]
* 1c. Delino unable to detect valid <<command_prefix, `INDEX`>> provided.
[none]
...
[none]
* 1d. Delino unable to detect valid <<command_prefix, `FLAG`>> provided.
[none]
** 1d1. Delino shows error message to the user.
+
Use case ends.
...
//tag::use_case_help[]
[discrete]
=== Use case: UC12 - Display list of commands in Delino using help
