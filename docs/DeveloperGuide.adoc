...
and reference it the same way as how the normal transactions were referenced from the json data. After discussion, we decided to create a GlobalData class
and store it in a separate json file and referenced separately.
