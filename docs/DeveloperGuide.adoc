...
* hall residents
* Want to keep track of diet
* Usually make payment first when eating together with friends
...
2.  Diet Tracker updates users' dieting mode
3.  User updates height
4.  Diet Tracker updates height of user
5.  User updates weight
6.  Diet Tracker updates weight of user
+
Use case ends.
...
** 1a1. Diet Tracker requests user to re-enter command with flag
...
** 3a1. Diet Tracker requests user to re-enter height in correct format
...
** 5a1. Diet Tracker requests user to re-enter weight in correct format
...
2.  Diet Tracker adds food item to user's log
+
Use case ends.
...
** 1a1. Diet Tracker requests user to re-enter food item in valid format.
** 1a2. User enters command in the correct format as requested by the diet tracker +
Steps 1a1-1a2 are repeated until the correct entered is correct. +
Use case ends.
...
2.  Diet Tracker shows the list based on flags entered
3.  User deletes item by index
4.  Diet Tracker deletes item tagged to specified index
+
Use case ends.
...
** 1a1. Diet Tracker prints out default list which contains food logged for the day

* 3a. Invalid or empty index keyed into command.
** 3a1. Diet Tracker requests user to re-enter index in correct format
...
4.  Diet Tracker edits the data of the item stored at the index.
+
Use case ends.
...
** 3b1. Diet Tracker requests user to re-enter command with at least one flag
...
1.  User key in the person name and optional details.
2.  Eylah add the person details.
3.  Eylah display the added person.
+
Use case ends.
...
[none]
* 1a. Eylah detects empty name.
+
[none]
** 1a1. Eylah shows an error message.
+
Use case ends.
...
+
[none]
** 1b1. Eylah shows an error message.
+
Use case ends.
...
1.  User key in the food name, price and involved person.
2.  Eylah adds the food details.
3.  Eylah display the foods and respective involved person.
+
Use case ends.
...
[none]
* 1a. Eylah detects empty food name, price or involved person.
+
[none]
** 1a1. Eylah shows an error message.
+
...
1.  User key request to calculate the cost.
2.  Eylah get the cost details.
