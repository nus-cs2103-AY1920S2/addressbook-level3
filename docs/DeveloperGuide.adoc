...
==== Updating UI
image::SortUpdateUi.png[] // TODO add in sequence diagram
...
==== Prefix Completion
// TODO Add/edit activity diagram
// TODO explain why those 2 prefixes 

// TODO Pom just sets prefix on second number
...
==== Auto Complete UI
// TODO add sequence diagram of how it is updated
...
// TODO sequence diagram for completion
// TODO sequence diagram for warning

==== Auto Complete Failure UI
// TODO sequence diagram for failure

=== Enhanced Find
We've built upon the existing find function in AB-3 to filter Tasks with names that:

. Have an edit distance of < 2
. Have the search term match the front of the names

[NOTE]
=====
The filtered list will still adhere to the existing sort order if defined.
=====
