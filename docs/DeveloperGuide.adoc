...
. If there are `Progress` objects that were previously in ProgressAddressBook but was removed due to an `unassign/delete` command,
add those `Progress` objects back in. Refer to `Section 3.2.2` for more information.
