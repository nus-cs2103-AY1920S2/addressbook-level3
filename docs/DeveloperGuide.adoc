...
`Main` has two classes called link:{repoURL}/src/main/java/fithelper/Main.java[`Main`] and link:{repoURL}/src/main/fithelper/MainApp.java[`MainApp`]. It is responsible for,
