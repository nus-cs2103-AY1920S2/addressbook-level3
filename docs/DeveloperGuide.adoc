...
.Architecture Diagram of Coupo Stash.
...
.Class Diagram representation of the Calendar mechanism
...
.Sequence diagram representation of the Calendar when the month view is updated.
